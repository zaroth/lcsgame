...
int getsquad(int id) {
    for(int i = 0; i < (int)squad.size(); i++)if(squad[i]->id == id)
            return i;
...
int id_getcar(int id) {
    for(int i = 0; i < (int)vehicle.size(); i++)if(vehicle[i]->id() == id)
            return i;
...
int getpoolcreature(int id) {
    for(int i = 0; i < (int)pool.size(); i++)if(pool[i]->id == id)
            return i;
...
int getvehicletype(int id) {
    for(int i = 0; i < (int)vehicletype.size(); i++)if(vehicletype[i]->id() == id)
            return i;
...
int getvehicletype(const string &idname) {
    for(int i = 0; i < (int)vehicletype.size(); i++)if(vehicletype[i]->idname() == idname)
            return i;
...
int getcliptype(int id) {
    for(int i = 0; i < (int)cliptype.size(); i++)if(cliptype[i]->get_id() == id)
            return i;
...
int getcliptype(const string &idname) {
    for(int i = 0; i < (int)cliptype.size(); i++)if(cliptype[i]->get_idname() == idname)
            return i;
...
int getweapontype(int id) {
    for(int i = 0; i < (int)weapontype.size(); i++)if(weapontype[i]->get_id() == id)
            return i;
...
int getweapontype(const string &idname) {
    for(int i = 0; i < (int)weapontype.size(); i++)if(weapontype[i]->get_idname() == idname)
            return i;
...
int getarmortype(int id) {
    for(int i = 0; i < (int)armortype.size(); i++)if(armortype[i]->get_id() == id)
            return i;
...
int getarmortype(const string &idname) {
    for(int i = 0; i < (int)armortype.size(); i++)if(armortype[i]->get_idname() == idname)
            return i;
...
int getloottype(int id) {
    for(int i = 0; i < (int)loottype.size(); i++)if(loottype[i]->get_id() == id)
            return i;
...
int getloottype(const string &idname) {
    for(int i = 0; i < (int)loottype.size(); i++)if(loottype[i]->get_idname() == idname)
            return i;
