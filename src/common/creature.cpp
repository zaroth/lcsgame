...
void makecreature(creaturest &cr, short type) {
    ...
    case CREATURE_WORKER_SWEATSHOP:
        ...
        sk = LCSrandom(6) + 5;
        cr.skill[SKILL_GARMENTMAKING] = sk;
        randomskills -= sk;
        break;
    ...
    case CREATURE_MERC:
        ...
        sk = LCSrandom(4) + 1;
        cr.skill[SKILL_ASSAULTRIFLE] = sk;
        randomskills -= sk;
        sk = LCSrandom(3);
        cr.skill[SKILL_SECURITY] = sk;
        randomskills -= sk;
        sk = LCSrandom(3);
        cr.skill[SKILL_HANDTOHAND] = sk;
        randomskills -= sk;
        sk = LCSrandom(3);
        cr.skill[SKILL_PISTOL] = sk;
        randomskills -= sk;
        sk = LCSrandom(2);
        cr.skill[SKILL_DRIVING] = sk;
        randomskills -= sk;
        break;
    ...
    case CREATURE_HICK:
        ...
        if(law[LAW_GUNCONTROL] == -2 && !LCSrandom(2)) {
            ...
            cr.weapon.type = WEAPON_TORCH;
        else
            cr.weapon.type = WEAPON_PITCHFORK;

        if(!LCSrandom(2))
            cr.armor.type = ARMOR_OVERALLS;
        else
            cr.armor.type = ARMOR_WIFEBEATER;
    ...
    case CREATURE_COP:
        ...
        randomskills -= sk;
        sk = LCSrandom(3) + 1;
        cr.skill[SKILL_RIFLE] = sk;
        randomskills -= sk;
        sk = LCSrandom(2) + 1;
        cr.skill[SKILL_CLUB] = sk;
        randomskills -= sk;
        sk = LCSrandom(2) + 1;
        cr.skill[SKILL_HANDTOHAND] = sk;
        randomskills -= sk;
    ...
    case CREATURE_GENETIC:
        switch(LCSrandom(10)) {
        case 0:
            strcpy(cr.name, "Genetic Monster");
            break;
        ...
        case 2:
            strcpy(cr.name, "Genetic Nightmare");
            break;

        case 3:
            strcpy(cr.name, "Mad Cow");
            break;
        ...
        case 5:
            strcpy(cr.name, "Six-legged Pig");
            break;

        case 6:
            strcpy(cr.name, "Purple Gorilla");
            break;

        case 7:
            strcpy(cr.name, "Warped Bear");
            break;

        case 8:
            strcpy(cr.name, "Writhing Mass");
            break;

        case 9:
            strcpy(cr.name, "Something Bad");
            break;
        }
    ...
    case CREATURE_PROSTITUTE:
        ...
        if(LCSrandom(2))
            cr.armor.type = ARMOR_CHEAPDRESS;
        else
            cr.armor.type = ARMOR_CLOTHES;
    ...
    case CREATURE_SOCIALITE:
        ...
        if(LCSrandom(2))
            cr.armor.type = ARMOR_EXPENSIVEDRESS;
        else
            cr.armor.type = ARMOR_EXPENSIVESUIT;
    ...
    case CREATURE_THIEF:
        ...
        switch(LCSrandom(5)) {
        case 0:
            getrecruitcreature(cr.name, CREATURE_SOCIALITE);
            break;

        case 1:
            getrecruitcreature(cr.name, CREATURE_CLERK);
            break;

        case 2:
            getrecruitcreature(cr.name, CREATURE_OFFICEWORKER);
            break;

        case 3:
            getrecruitcreature(cr.name, CREATURE_CRITIC_ART);
            break;

        case 4:
            getrecruitcreature(cr.name, CREATURE_CRITIC_MUSIC);
            break;
        }
