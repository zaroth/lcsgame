...
//{{{ Male
    {
        ...
        case 9:
            strcat(str, "Alejandro");
            break;

        case 10:
            strcat(str, "Alexander");
            break;
        ...
        case 61:
            strcat(str, "Christian");
            break;

        case 62:
            strcat(str, "Christopher");
            break;
...
//{{{ Female
    {
        ...
        case 53:
            strcat(str, "Cassandra");
            break;

        case 54:
            strcat(str, "Catherine");
            break;
...
//{{{ Last Name
{
    ...
    case 44:
        strcat(str, "Blackenship");
        break;

    case 45:
        strcat(str, "Blanchard");
        break;
    ...
    case 90:
        strcat(str, "Cartwright");
        break;

    case 91:
        strcat(str, "Cavallero");
        break;
    ...
    case 138:
        strcat(str, "de la Cruz");
        break;

    case 139:
        strcat(str, "Cunningham");
        break;
    ...
    case 186:
        strcat(str, "Fairbanks");
        break;

    case 187:
        strcat(str, "Fairchild");
        break;
    ...
    case 200:
        strcat(str, "Fitzgerald");
        break;

    case 201:
        strcat(str, "Fitzpatrick");
        break;
    ...
    case 261:
        strcat(str, "Hemingway");
        break;

    case 262:
        strcat(str, "Henderson");
        break;
    ...
    case 272:
        strcat(str, "Himelstein");
        break;

    case 273:
        strcat(str, "Hoddinott");
        break;
    ...
    case 289:
        strcat(str, "Hunnicutt");
        break;

    case 290:
        strcat(str, "Hutchison");
        break;
    ...
    case 361:
        strcat(str, "MacKinley");
        break;

    case 362:
        strcat(str, "MacKinnon");
        break;
    ...
    case 478:
        strcat(str, "Pendergrass");
        break;

    case 479:
        strcat(str, "Pendleton");
        break;
    ...
    case 523:
        strcat(str, "Ratzenberger");
        break;

    case 524:
        strcat(str, "Ravenhill");
        break;
    ...
    case 613:
        strcat(str, "Shuttleworth");
        break;

    case 614:
        strcat(str, "Sidebottom");
        break;
    ...
    case 618:
        strcat(str, "Silverman");
        break;

    case 619:
        strcat(str, "Silverstein");
        break;
    ...
    case 743:
        strcat(str, "Underhill");
        break;

    case 744:
        strcat(str, "Underdown");
        break;

    case 745:
        strcat(str, "Underwood");
        break;
    ...
    case 794:
        strcat(str, "Winchester");
        break;

    case 795:
        strcat(str, "Winkelman");
        break;
...
bool verifyworklocation(Creature &cr, char test_location, char test_type) {
    ...
    case CREATURE_CCS_VIGILANTE:
        if(ccs_kills == 2)
            okaysite[SITE_OUTDOOR_BUNKER] = 1;

        if(ccs_kills == 1)
            okaysite[SITE_RESIDENTIAL_BOMBSHELTER] = 1;

        if(ccs_kills == 0)
            okaysite[SITE_BUSINESS_BARANDGRILL] = 1;
...
void conservatise(Creature &cr) {
    if(cr.align == ALIGN_LIBERAL && cr.juice > 0)
        cr.juice = 0;
...
void liberalize(Creature &cr, bool rename) {
    if(cr.align == ALIGN_CONSERVATIVE && cr.juice > 0)
        cr.juice = 0;
