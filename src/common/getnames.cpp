...
void getweapon(char *str, int type) {
    ...
    if(year < 2100) {
        ...
        case WEAPON_BASEBALLBAT:
            strcpy(str, "Spaceball Bat");
            break;

        case WEAPON_KNIFE:
            strcpy(str, "Vibro-Knife");
            break;
        ...
        case WEAPON_SWORD:
            strcpy(str, "Light Sword");
            break;

        case WEAPON_DAISHO:
            strcpy(str, "Twin Sword");
            break;
...
void getweaponfull(char *str, int type, int subtype) {
    ...
    if(year < 2100) {
        ...
        case WEAPON_HAMMER:
            strcpy(str, "Dwarven Hammer");
            break;

        case WEAPON_MAUL:
            strcpy(str, "Maul of Anrin");
            break;

        case WEAPON_CROSS:
            strcpy(str, "Silver Cross");
            break;

        case WEAPON_STAFF:
            strcpy(str, "Wizard's Staff");
            break;
        ...
        case WEAPON_SHANK:
            strcpy(str, "Cyber Shank");
            break;

        case WEAPON_SYRINGE:
            strcpy(str, "Medical Injector");
            break;

        case WEAPON_REVOLVER_38:
            strcpy(str, ".38 Slug Pistol");
            break;
        ...
        case WEAPON_SEMIPISTOL_9MM:
            strcpy(str, "9mm Laser Pistol");
            break;

        case WEAPON_SEMIPISTOL_45:
            strcpy(str, ".45 Laser Pistol");
            break;

        case WEAPON_SEMIRIFLE_AR15:
            strcpy(str, "X15 Personal Laser");
            break;

        case WEAPON_SMG_MP5:
            strcpy(str, "Beijing Prince SMG");
            break;

        case WEAPON_CARBINE_M4:
            strcpy(str, "J4 Laser Carbine");
            break;

        case WEAPON_AUTORIFLE_M16:
            strcpy(str, "X15 Military Laser");
            break;

        case WEAPON_AUTORIFLE_AK47:
            strcpy(str, "P74 War Laser");
            break;

        case WEAPON_SHOTGUN_PUMP:
            strcpy(str, "Plasma Shotgun");
            break;
        ...
        case WEAPON_DAISHO:
            switch(subtype) {
            case 0:
                strcpy(str, "Twin Swords of Liberalism");
                break;

            case 1:
                strcpy(str, "Retribution Sword");
                break;

            case 2:
                strcpy(str, "Justice Blade");
                break;
            }
        ...
        case WEAPON_CHAIN:
            strcpy(str, "Industrial Cyber-Arm");
            break;

        case WEAPON_NIGHTSTICK:
            strcpy(str, "Electro-Shock Stick");
            break;

        case WEAPON_GAVEL:
            strcpy(str, "Laser Gavel");
            break;

        case WEAPON_PITCHFORK:
            strcpy(str, "Space Pitchfork");
            break;

        case WEAPON_CROWBAR:
            strcpy(str, "Forcefield Prybar");
            break;

        case WEAPON_TORCH:
            strcpy(str, "Burning Flare");
            break;

        case WEAPON_GUITAR:
            strcpy(str, "Cyber-Keytar");
            break;

        case WEAPON_SPRAYCAN:
            strcpy(str, "Holo-Paint");
            break;
...
void getarmor(char *str, int type, int subtype) {
    ...
    case ARMOR_WIFEBEATER:
        strcpy(str, "Wife Beater");
        break;

    case ARMOR_TRENCHCOAT:
        strcpy(str, "Trenchcoat");
        break;

    case ARMOR_WORKCLOTHES:
        strcpy(str, "Work Clothes");
        break;
    ...
    case ARMOR_CHEAPSUIT:
        strcpy(str, "Cheap Suit");
        break;

    case ARMOR_EXPENSIVESUIT:
        strcpy(str, "Expensive Suit");
        break;

    case ARMOR_BLACKSUIT:
        strcpy(str, "Black Suit");
        break;

    case ARMOR_CHEAPDRESS:
        strcpy(str, "Cheap Dress");
        break;

    case ARMOR_EXPENSIVEDRESS:
        strcpy(str, "Expensive Dress");
        break;

    case ARMOR_BLACKDRESS:
        strcpy(str, "Black Dress");
        break;
    ...
    case ARMOR_BLACKROBE:
        strcpy(str, "Black Robe");
        break;

    case ARMOR_CLOWNSUIT:
        strcpy(str, "Clown Suit");
        break;

    case ARMOR_ELEPHANTSUIT:
        strcpy(str, "Elephant Suit");
        break;

    case ARMOR_DONKEYSUIT:
        strcpy(str, "Donkey Suit");
        break;

    case ARMOR_BONDAGEGEAR:
        strcpy(str, "Bondage Gear");
        break;

    case ARMOR_MASK:
        switch(subtype) {
        case MASK_ASHCROFT:
            strcpy(str, "Ashcroft Mask");
            break;

        case MASK_BARR:
            strcpy(str, "Bob Barr Mask");
            break;

        case MASK_BLAIR:
            strcpy(str, "Blair Mask");
            break;

        case MASK_BUSH_BARBARA:
            strcpy(str, "Brb. Bush Mask");
            break;

        case MASK_BUSH_GEORGE:
            strcpy(str, "G HW Bush Mask");
            break;

        case MASK_BUSH_GEORGE2:
            strcpy(str, "G W. Bush Mask");
            break;

        //LIMIT ---------------------------------------------:
        case MASK_CARTER:
            strcpy(str, "Carter Mask");
            break;

        case MASK_CHENEY:
            strcpy(str, "Cheney Mask");
            break;

        case MASK_CLINTON_BILL:
            strcpy(str, "B Clinton Mask");
            break;

        case MASK_CLINTON_HILLARY:
            strcpy(str, "H Clinton Mask");
            break;

        case MASK_FALWELL:
            strcpy(str, "Falwell Mask");
            break;

        case MASK_FORD:
            strcpy(str, "Gld. Ford Mask");
            break;

        case MASK_GORE_AL:
            strcpy(str, "Al Gore Mask");
            break;

        case MASK_GORE_TIPPER:
            strcpy(str, "Tpr. Gore Mask");
            break;

        case MASK_GUY_FAWKES:
            strcpy(str, "G. Fawkes Mask");
            break;

        case MASK_TED_STEVENS:
            strcpy(str, "T Stevens Mask");
            break;

        case MASK_HELMS:
            strcpy(str, "Helms Mask");
            break;

        case MASK_JASON:
            strcpy(str, "Jason Mask");
            break;

        case MASK_LINCOLN:
            strcpy(str, "Lincoln Mask");
            break;
        ...
        case MASK_KISSINGER:
            strcpy(str, "Kissinger Mask");
            break;

        case MASK_NIXON:
            strcpy(str, "Nixon Mask");
            break;

        case MASK_POWELL:
            strcpy(str, "Powell Mask");
            break;

        case MASK_REAGAN_NANCY:
            strcpy(str, "N. Reagan Mask");
            break;

        case MASK_REAGAN_RONALD:
            strcpy(str, "R. Reagan Mask");
            break;

        case MASK_RICE:
            strcpy(str, "Cn. Rice Mask");
            break;

        case MASK_ROBERTSON:
            strcpy(str, "Robertson Mask");
            break;

        case MASK_RUMSFELD:
            strcpy(str, "Rumsfeld Mask");
            break;

        case MASK_SATAN:
            strcpy(str, "Satan Mask");
            break;

        case MASK_STARR:
            strcpy(str, "Ken Starr Mask");
            break;

        case MASK_THURMOND:
            strcpy(str, "Thurmond Mask");
            break;

        case MASK_WASHINGTON:
            strcpy(str, "Washngton Mask");
            break;

        case MASK_WAXMAN:
            strcpy(str, "Waxman Mask");
            break;

        //LIMIT ---------------------------------------------:
        case MASK_JESUS:
            strcpy(str, "Jesus Mask");
            break;

        case MASK_COLEMAN_GARY:
            strcpy(str, "G Coleman Mask");
            break;

        case MASK_MADONNA:
            strcpy(str, "Madonna Mask");
            break;

        case MASK_SPEARS:
            strcpy(str, "B Spears Mask");
            break;

        case MASK_EMINEM:
            strcpy(str, "Eminem Mask");
            break;

        case MASK_AGUILERA:
            strcpy(str, "C Aguilra Mask");
            break;

        case MASK_WAHLBERG:
            strcpy(str, "M Wahlbrg Mask");
            break;

        case MASK_IGGYPOP:
            strcpy(str, "Iggy Pop Mask");
            break;

        case MASK_CASH:
            strcpy(str, "Jny. Cash Mask");
            break;

        case MASK_BINLADEN:
            strcpy(str, "bin Laden Mask");
            break;

        case MASK_LORDS:
            strcpy(str, "Tr. Lords Mask");
            break;

        case MASK_SHIELDS:
            strcpy(str, "Br. Shlds Mask");
            break;

        case MASK_JACKSON_MICHAEL:
            strcpy(str, "M Jackson Mask");
            break;

        case MASK_CRUTHERS:
            strcpy(str, "Cruthers Mask");
            break;

        case MASK_KING_DON:
            strcpy(str, "Don King Mask");
            break;
    ...
    case ARMOR_MILITARY:
        strcpy(str, "Army Uniform");
        break;

    case ARMOR_PRISONGUARD:
        strcpy(str, "Guard Uniform");
        break;

    case ARMOR_PRISONER:
        strcpy(str, "Orange Jmpsuit");
        break;
    ...
    case ARMOR_MITHRIL:
        strcpy(str, "Mithril Mail");
        break;

    case ARMOR_CIVILLIANARMOR:
        strcpy(str, "Body Armor");
        break;

    case ARMOR_SWATARMOR:
        strcpy(str, "SWAT Armor");
        break;

    case ARMOR_POLICEARMOR:
        strcpy(str, "PoliceBdyArmor");
        break;

    case ARMOR_ARMYARMOR:
        strcpy(str, "Army BodyArmor");
        break;

    case ARMOR_HEAVYARMOR:
        strcpy(str, "HeavyBodyArmor");
        break;

    case ARMOR_BUNKERGEAR:
        strcpy(str, "Bunker Gear");
        break;

    case ARMOR_DEATHSQUADUNIFORM:
        strcpy(str, "DSquad Uniform");
        break;
    }
}
...
void getarmorfull(char *str, int type, int subtype) {
    ...
    case ARMOR_MASK:
        ...
        case MASK_BLAIR:
            strcpy(str, "Tony Blair Mask");
            break;

        case MASK_BUSH_BARBARA:
            strcpy(str, "Barbara Bush Mask");
            break;

        case MASK_BUSH_GEORGE:
            strcpy(str, "George HW Bush Mask");
            break;
        ...
        case MASK_CHENEY:
            strcpy(str, "Dick Cheney Mask");
            break;

        case MASK_CLINTON_BILL:
            strcpy(str, "Bill Clinton Mask");
            break;

        case MASK_CLINTON_HILLARY:
            strcpy(str, "Hillary Clinton Msk");
            break;

        case MASK_FALWELL:
            strcpy(str, "Jerry Falwell Mask");
            break;

        case MASK_FORD:
            strcpy(str, "Gerald Ford Mask");
            break;
        ...
        case MASK_GORE_TIPPER:
            strcpy(str, "Tipper Gore Mask");
            break;

        case MASK_GUY_FAWKES:
            strcpy(str, "Guy Fawkes Mask");
            break;

        case MASK_TED_STEVENS:
            strcpy(str, "Ted Stevens Mask");
            break;

        case MASK_HELMS:
            strcpy(str, "Jesse Helms Mask");
            break;
        ...
        case MASK_LINCOLN:
            strcpy(str, "Abraham Lincoln Msk");
            break;

        case MASK_KENNEDY_JOHN:
            strcpy(str, "John F Kennedy Mask");
            break;

        case MASK_KENNEDY_ROBERT:
            strcpy(str, "Robert Kennedy Mask");
            break;

        case MASK_KISSINGER:
            strcpy(str, "Henry Kissinger Msk");
            break;

        case MASK_NIXON:
            strcpy(str, "Richard Nixon Mask");
            break;

        case MASK_POWELL:
            strcpy(str, "Colin Powell Mask");
            break;

        case MASK_REAGAN_NANCY:
            strcpy(str, "Nancy Reagan Mask");
            break;

        case MASK_REAGAN_RONALD:
            strcpy(str, "Ronald Reagan Mask");
            break;

        case MASK_RICE:
            strcpy(str, "Condoleezza Rice Mk");
            break;

        case MASK_ROBERTSON:
            strcpy(str, "Pat Robertson Mask");
            break;

        case MASK_RUMSFELD:
            strcpy(str, "Donald Rumsfeld Msk");
            break;
        ...
        case MASK_THURMOND:
            strcpy(str, "Strom Thurmond Mask");
            break;

        case MASK_WASHINGTON:
            strcpy(str, "George Washngtn Msk");
            break;
        ...
        case MASK_SPEARS:
            strcpy(str, "Britney Spears Mask");
            break;
        ...
        case MASK_AGUILERA:
            strcpy(str, "Chrstna Aguilera Mk");
            break;

        case MASK_WAHLBERG:
            strcpy(str, "Mark Wahlbrg Mask");
            break;
        ...
        case MASK_CASH:
            strcpy(str, "Johnny Cash Mask");
            break;

        case MASK_BINLADEN:
            strcpy(str, "Osama bin Laden Msk");
            break;

        case MASK_LORDS:
            strcpy(str, "Traci Lords Mask");
            break;

        case MASK_SHIELDS:
            strcpy(str, "Brooke Shields Mask");
            break;

        case MASK_JACKSON_MICHAEL:
            strcpy(str, "Michael Jackson Msk");
            break;

        case MASK_CRUTHERS:
            strcpy(str, "Scatman Cruthers Mk");
            break;
    ...
    case ARMOR_SWATARMOR:
        strcpy(str, "Tactical SWAT Armor");
        break;

    case ARMOR_POLICEARMOR:
        strcpy(str, "Police Body Armor");
        break;

    case ARMOR_ARMYARMOR:
        strcpy(str, "Army Body Armor");
        break;
...
void getmaskdesc(char *str, short mask) {
    ...
    //LIMIT-------------------------------------:--------------------------------------:
    case MASK_ASHCROFT:
        strcpy(str, "U.S. Senator, Attorney General");
        break;

    case MASK_BARR:
        strcpy(str, "U.S. Representative");
        break;

    case MASK_BLAIR:
        strcpy(str, "British Prime Minister");
        break;

    case MASK_BUSH_BARBARA:
        strcpy(str, "U.S. First Lady");
        break;

    case MASK_BUSH_GEORGE:
        strcpy(str, "U.S. President");
        break;
    ...
    case MASK_CHENEY:
        strcpy(str, "U.S. Vice President, CEO");
        break;
    ...
    case MASK_CLINTON_HILLARY:
        strcpy(str, "U.S. Senator, First Lady");
        break;
    ...
    case MASK_GORE_AL:
        strcpy(str, "U.S. Vice President");
        break;

    //LIMIT-------------------------------------:--------------------------------------:
    case MASK_GORE_TIPPER:
        strcpy(str, "U.S. Second Lady");
        break;

    case MASK_GUY_FAWKES:
        strcpy(str, "Remember the 5th of November");
        break;

    case MASK_TED_STEVENS:
        strcpy(str, "U.S. Senator");
        break;
    ...
    case MASK_JASON:
        strcpy(str, "A Hockey Mask a la Friday the 13th");
        break;

    case MASK_LINCOLN:
        strcpy(str, "U.S. President, Assassinated");
        break;
    ...
    case MASK_KENNEDY_ROBERT:
        strcpy(str, "U.S. Senator, Assassinated");
        break;

    case MASK_KISSINGER:
        strcpy(str, "U.S. Secretary of State");
        break;

    case MASK_NIXON:
        strcpy(str, "U.S. President, Resigned");
        break;

    case MASK_POWELL:
        strcpy(str, "U.S. Secretary of State, General");
        break;
    ...
    case MASK_RICE:
        strcpy(str, "U.S. National Security Advisor");
        break;

    case MASK_ROBERTSON:
        strcpy(str, "Televangelist");
        break;

    case MASK_RUMSFELD:
        strcpy(str, "U.S. Secretary of Defense");
        break;

    case MASK_SATAN:
        strcpy(str, "Prince of Darkness, Red with Horns");
        break;

    case MASK_STARR:
        strcpy(str, "Independent Counsel");
        break;
    ...
    case MASK_JESUS:
        strcpy(str, "The Son of God, The Lamb, He died 4 U");
        break;

    case MASK_COLEMAN_GARY:
        strcpy(str, "Actor, Candidate for Governor");
        break;

    case MASK_MADONNA:
        strcpy(str, "Singer, Actor");
        break;
...
void getarmorfull(char *str, armorst &armor, char superfull) {
    if(superfull)
        ...
        getarmor(str, armor.type, armor.subtype);
...
void getclip(char *str, int clip) {
    ...
    if(year < 2100) {
        switch(clip) {
        case CLIP_9:
            strcat(str, "9mm Pistol Mag");
            break;

        case CLIP_45:
            strcat(str, ".45 Pistol Mag");
            break;

        case CLIP_ASSAULT:
            strcat(str, "Aslt/Rifle Mag");
            break;

        case CLIP_SMG:
            strcat(str, "9mm SMG Mag");
            break;

        case CLIP_38:
            strcat(str, ".38 Speedloader");
            break;
        ...
        switch(clip) {
        case CLIP_9:
            strcat(str, "9mm Powerpack");
            break;

        case CLIP_45:
            strcat(str, ".45 Powerpack");
            break;

        case CLIP_ASSAULT:
            strcat(str, "Rifle Powerpack");
            break;

        case CLIP_SMG:
            strcat(str, "SMG Powerpack");
            break;

        case CLIP_38:
            strcat(str, ".38 Slug Mag");
            break;
        ...
        case CLIP_BUCKSHOT:
            strcat(str, "Shotgun Plasma Pack");
            break;
...
void getloot(char *str, int loot) {
    ...
    case LOOT_FINECLOTH:
        strcat(str, "Fine Cloth");
        break;

    case LOOT_CHEMICAL:
        strcat(str, "Weird Chemical");
        break;
    ...
    case LOOT_INTHQDISK:
        strcat(str, "Intel. HQ Data Disk");
        break;

    case LOOT_CORPFILES:
        strcat(str, "Secret Corporate Files");
        break;

    case LOOT_JUDGEFILES:
        strcat(str, "Judge Corrupt. Evidence");
        break;

    case LOOT_RESEARCHFILES:
        strcat(str, "Research Papers");
        break;

    case LOOT_PRISONFILES:
        strcat(str, "Prison Records");
        break;

    case LOOT_CABLENEWSFILES:
        strcat(str, "Cable News Memos");
        break;
    ...
    if(cr.align == -1) {
        if(cr.juice <= -50) {
            if(law[LAW_FREESPEECH] == -2)
                strcpy(str, "[Darn] Worthless");
            else
                strcpy(str, "Damn Worthless");
        } else if(cr.juice <= -10)
            strcpy(str, "Conservative Dregs");
        else if(cr.juice < 0)
            strcpy(str, "Conservative Punk");
        else if(cr.juice < 10)
            strcpy(str, "Mindless Conservative");
        else if(cr.juice < 50)
            strcpy(str, "Wrong-Thinker");
        else if(cr.juice < 100) {
            if(law[LAW_FREESPEECH] == -2)
                strcpy(str, "Stubborn as [Heck]");
            else
                strcpy(str, "Stubborn as Hell");
        } else if(cr.juice < 200) {
            if(law[LAW_FREESPEECH] == -2)
                strcpy(str, "Heartless [Jerk]");
            else
                strcpy(str, "Heartless Bastard");
        } else if(cr.juice < 500)
            strcpy(str, "Insane Vigilante");
        else if(cr.juice < 1000)
            strcpy(str, "Arch-Conservative");
        else
            strcpy(str, "Evil Incarnate");
    } else if(cr.align == 0) {
        if(cr.juice <= -50) {
            if(law[LAW_FREESPEECH] == -2)
                strcpy(str, "[Darn] Worthless");
            ...
            strcpy(str, "Society's Dregs");
        else if(cr.juice < 0)
            strcpy(str, "Non-Liberal Punk");
        else if(cr.juice < 10)
            strcpy(str, "Non-Liberal");
        else if(cr.juice < 50)
            strcpy(str, "Hard Working");
        else if(cr.juice < 100)
            strcpy(str, "Respected");
        else if(cr.juice < 200)
            strcpy(str, "Upstanding Citizen");
        else if(cr.juice < 500)
            strcpy(str, "Great Person");
        else if(cr.juice < 1000)
            strcpy(str, "Peacemaker");
        else
            strcpy(str, "Peace Prize Winner");
    } else {
        if(cr.juice <= -50) {
            if(law[LAW_FREESPEECH] == -2)
                strcpy(str, "[Darn] Worthless");
            ...
            strcpy(str, "Socialist Threat");
        else if(cr.juice < 200)
            strcpy(str, "Revolutionary");
        else if(cr.juice < 500)
            strcpy(str, "Urban Commando");
        else if(cr.juice < 1000)
            strcpy(str, "Liberal Guardian");
        else
            strcpy(str, "Elite Liberal");
    }
}
...
void getlaw(char *str, int l) {
    ...
    case LAW_ANIMALRESEARCH:
        strcpy(str, "Animal Research");
        break;

    case LAW_POLICEBEHAVIOR:
        strcpy(str, "Police Behavior");
        break;
    ...
    case LAW_LABOR:
        strcpy(str, "Workers' Rights");
        break;

    case LAW_GAY:
        strcpy(str, "Homosexual Rights");
        break;

    case LAW_CORPORATE:
        strcpy(str, "Corporate Ethics");
        break;

    case LAW_FREESPEECH:
        strcpy(str, "Freedom of Speech");
        break;
...
void getcarfull(char *str, int type) {
    ...
    case VEHICLE_STATIONWAGON:
        strcat(str, "Station Wagon");
        break;

    case VEHICLE_SPORTSCAR:
        strcat(str, "Sportscar");
        break;
    ...
    case VEHICLE_PICKUP:
        strcat(str, "Pickup Truck");
        break;

    case VEHICLE_POLICECAR:
        strcat(str, "Police Cruiser");
        break;
...
void getcarfull(char *str, vehiclest &car, char halffull) {
    ...
    if(halffull)
        getcar(str2, car.type);
    else
        getcarfull(str2, car.type);
...
void getcarcolor(char *str, int type) {
    ...
    switch(type) {
    case VEHICLECOLOR_RED:
        strcat(str, "Red");
        break;

    case VEHICLECOLOR_WHITE:
        strcat(str, "White");
        break;

    case VEHICLECOLOR_BLUE:
        strcat(str, "Blue");
        break;

    case VEHICLECOLOR_BEIGE:
        strcat(str, "Beige");
        break;

    case VEHICLECOLOR_POLICE:
        strcat(str, "Police-Marked");
        break;

    case VEHICLECOLOR_TAXI:
        strcat(str, "Taxi-Striped");
        break;
...
void cityname(char *story) {
    switch(LCSrandom(42)) {
    case 0:
        strcpy(story, "San Francisco, CA");
        break;

    case 1:
        strcpy(story, "Boston, MA");
        break;

    case 2:
        strcpy(story, "Los Angeles, CA");
        break;

    case 3:
        strcpy(story, "Detroit, MI");
        break;

    case 4:
        strcpy(story, "Cleveland, OH");
        break;

    case 5:
        strcpy(story, "Cincinnati, OH");
        break;

    case 6:
        strcpy(story, "New York, NY");
        break;

    case 7:
        strcpy(story, "Chicago, IL");
        break;

    case 8:
        strcpy(story, "Trenton, NJ");
        break;

    case 9:
        strcpy(story, "Denver, CO");
        break;

    case 10:
        strcpy(story, "Phoenix, AZ");
        break;

    case 11:
        strcpy(story, "Little Rock, AR");
        break;

    case 12:
        strcpy(story, "Houston, TX");
        break;

    case 13:
        strcpy(story, "Dallas, TX");
        break;

    case 14:
        strcpy(story, "Hartford, CT");
        break;

    case 15:
        strcpy(story, "Miami, FL");
        break;
    ...
    case 17:
        strcpy(story, "Seattle, WA");
        break;

    case 18:
        strcpy(story, "Salt Lake City, UT");
        break;

    case 19:
        strcpy(story, "Philadelphia, PA");
        break;

    case 20:
        strcpy(story, "San Antonio, TX");
        break;

    case 21:
        strcpy(story, "Columbus, OH");
        break;

    case 22:
        strcpy(story, "Atlanta, GA");
        break;

    case 23:
        strcpy(story, "Buffalo, NY");
        break;

    case 24:
        strcpy(story, "Orlando, FL");
        break;

    case 25:
        strcpy(story, "Syracuse, NY");
        break;

    case 26:
        strcpy(story, "Baltimore, MD");
        break;

    case 27:
        strcpy(story, "Washington D.C.");
        break;

    case 28:
        strcpy(story, "Memphis, TN");
        break;

    case 29:
        strcpy(story, "Brooklyn, NY");
        break;

    case 30:
        strcpy(story, "New Orleans, LA");
        break;

    case 31:
        strcpy(story, "Albany, NY");
        break;

    case 32:
        strcpy(story, "Jackson, MS");
        break;

    case 33:
        strcpy(story, "Waco, TX");
        break;

    case 34:
        strcpy(story, "Oklahoma, OK");
        break;

    case 35:
        strcpy(story, "Austin, TX");
        break;

    case 36:
        strcpy(story, "Nashville, TN");
        break;
    ...
    case 38:
        strcpy(story, "Tampa, FL");
        break;

    case 39:
        strcpy(story, "San Diego, CA");
        break;

    case 40:
        strcpy(story, "El Paso, TX");
        break;
