...
void getrecruitcreature(char *str, int type) {
    ...
    case CREATURE_CORPORATE_CEO:
        strcat(str, "CEO of a Corporation");
        break;
    ...
    case CREATURE_SWAT:
        strcat(str, "Police SWAT");
        break;

    case CREATURE_DEATHSQUAD:
        strcat(str, "Death Squad");
        break;
...
void getview(char *str, short view) {
    ...
    case VIEW_GAY:
        strcat(str, "Homosexual Rights");
        break;

    case VIEW_DEATHPENALTY:
        strcat(str, "Death Penalty");
        break;
