...
void special_bouncer_assess_squad() {
    ...
    if(!autoadmit) {
        ...
        case REJECTED_CCS:
            ...
            case 1:
                addstr("\"Woah... you think you're coming in here?\"", gamelog);
                break;

            case 2:
                addstr("\"Check out this fool. Heh.\"", gamelog);
                break;

            case 3:
                addstr("\"Want some trouble, dumpster breath?\"", gamelog);
                break;

            case 4:
                addstr("\"You're gonna stir up the hornet's nest, fool.\"", gamelog);
                break;

            case 5:
                addstr("\"Come on, take a swing at me. Just try it.\"", gamelog);
                break;

            case 6:
                addstr("\"You really don't want to fuck with me.\"", gamelog);
                break;

            case 7:
                addstr("\"Hey girly, have you written your will?\"", gamelog);
                break;

            case 8:
                addstr("\"Oh, you're trouble. I *like* trouble.\"", gamelog);
                break;

            case 9:
                addstr("\"I'll bury you in those planters over there.\"", gamelog);
                break;

            case 10:
                addstr("\"Looking to check on the color of your blood?\"", gamelog);
                break;
            }
        ...
        case REJECTED_NUDE:
            ...
            case 1:
                addstr("\"Put some clothes on! That's disgusting.\"", gamelog);
                break;

            case 2:
                addstr("\"No! No, you can't come in naked! God!!\"", gamelog);
                break;

            case 3:
                addstr("\"No shoes, no shirt and you don't get service\"", gamelog);
                break;
            }
        ...
        case REJECTED_UNDERAGE:
            ...
            case 1:
                addstr("\"Find some kiddy club.\"", gamelog);
                break;

            case 2:
                addstr("\"You don't look 18 to me.\"", gamelog);
                break;

            case 3:
                addstr("\"Go back to your treehouse.\"", gamelog);
                break;

            case 4:
                addstr("\"Where's your mother?\"", gamelog);
                break;
            }
        ...
        case REJECTED_FEMALE:
            ...
            case 1:
                addstr("\"This 'ain't no sewing circle, ma'am.\"", gamelog);
                break;

            case 2:
                addstr("\"Sorry ma'am, this place is only for the men.\"", gamelog);
                break;

            case 3:
                addstr("\"Where's your husband?\"", gamelog);
                break;
            }
        ...
        case REJECTED_FEMALEISH:
            ...
            case 1:
                addstr("\"Y'know... the \'other\' guys won't like you much.\"", gamelog);
                break;

            case 2:
                addstr("\"Uhh... can't let you in, ma'am. Sir. Whatever.\"", gamelog);
                break;
            }
        ...
        case REJECTED_DRESSCODE:
            ...
            case 1:
                addstr("\"We have a dress code here.\"", gamelog);
                break;

            case 2:
                addstr("\"I can't let you in looking like that.\"", gamelog);
                break;
            }
        ...
        case REJECTED_SMELLFUNNY:
            ...
            case 1:
                addstr("\"Not letting you in. Because I said so.\"", gamelog);
                break;

            case 2:
                addstr("\"There's just something off about you.\"", gamelog);
                break;

            case 3:
                addstr("\"Take a shower.\"", gamelog);
                break;

            case 4:
                addstr("\"You'd just harass the others, wouldn't you?\"", gamelog);
                break;
            ...
            case 5:
                if(law[LAW_FREESPEECH] == -2)
                    ...
                    addstr("\"Get the hell out of here.\"", gamelog);
        ...
        case REJECTED_BLOODYCLOTHES:
            ...
            case 1:
                addstr("\"Absolutely not. Clean up a bit.\"", gamelog);
                break;

            case 2:
                addstr("\"This isn't a goth club, bloody clothes don't cut it here.\"", gamelog);
                break;

            case 3:
                addstr("\"Uh, maybe you should wash... replace... those clothes.\"", gamelog);
                break;

            case 4:
                addstr("\"Did you spill something on your clothes?\"", gamelog);
                break;

            case 5:
                addstr("\"Come back when you get the red wine out of your clothes.\"", gamelog);
                break;
            }
        ...
        case REJECTED_DAMAGEDCLOTHES:
            ...
            case 1:
                addstr("\"This isn't a goth club, ripped clothes don't cut it here.\"", gamelog);
                break;
            }
        ...
        case REJECTED_SECONDRATECLOTHES:
            ...
            case 1:
                addstr("\"If badly cut clothing is a hot new trend, I missed it.\"", gamelog);
                break;
            }
        ...
        case REJECTED_WEAPONS:
            ...
            case 1:
                addstr("\"I can't let you in carrying that.\"", gamelog);
                break;

            case 2:
                addstr("\"I can't let you take that in.\"", gamelog);
                break;

            case 3:
                addstr("\"Come to me armed, and I'll tell you to take a hike.\"", gamelog);
                break;

            case 4:
                addstr("\"Real men fight with fists. And no, you can't come in.\"", gamelog);
                break;
            }
        ...
        case NOT_REJECTED:
            ...
            case 1:
                addstr("\"Let me get the door for you.\"", gamelog);
                break;

            case 2:
                addstr("\"Ehh, alright, go on in.\"", gamelog);
                break;

            case 3:
                addstr("\"Come on in.\"", gamelog);
                break;
            }
        ...
        if(c == 'y') {
            ...
            if(maxp > -1) {
                ...
                if(succeed) {
                    ...
                    case 3:
                        addstr("mugging", gamelog);
                        break;

                    case 4:
                        addstr("burglary", gamelog);
                        break;

                    case 5:
                        addstr("property destruction", gamelog);
                        break;
                    ...
                    case 7:
                        addstr("libel", gamelog);
                        break;

                    case 8:
                        addstr("slander", gamelog);
                        break;

                    case 9:
                        addstr("sodomy", gamelog);
                        break;

                    case 10:
                        addstr("obstruction of justice", gamelog);
                        break;
                    ...
                    case 12:
                        addstr("public indecency", gamelog);
                        break;
...
void special_security(bool metaldetect) {
    ...
    case REJECTED_NUDE:
        ...
        if(autoadmit)
            ...
            case 1:
                addstr("\"Back off, creep!\"", gamelog);
                break;

            case 2:
                addstr("\"Jesus!! Somebody call the cops!\"", gamelog);
                break;

            case 3:
                addstr("\"Are you sleepwalking?!\"", gamelog);
                break;
            }
    ...
    case REJECTED_UNDERAGE:
        ...
        case 1:
            addstr("\"You're too young to work here.\"", gamelog);
            break;

        case 2:
            addstr("\"Go play someplace else.\"", gamelog);
            break;
    ...
    case REJECTED_SMELLFUNNY:
        ...
        case 1:
            addstr("\"Hmm... can I see your badge?\"", gamelog);
            break;
        ...
        case 3:
            addstr("\"You must be new. You'll need your badge.\"", gamelog);
            break;
        }
    ...
    case REJECTED_BLOODYCLOTHES:
        ...
        case 1:
            addstr("\"Are you hurt?! The aid station is the other way!\"", gamelog);
            break;

        case 2:
            addstr("\"Your clothes, that's blood!\"", gamelog);
            break;

        case 3:
            addstr("\"Blood?! That's more than a little suspicious...\"", gamelog);
            break;

        case 4:
            addstr("\"Did you just butcher a cat?!\"", gamelog);
            break;

        case 5:
            addstr("\"Blood everywhere...?\"", gamelog);
            break;
        }
    ...
    case REJECTED_DAMAGEDCLOTHES:
        ...
        case 1:
            addstr("\"Is that a damaged halloween costume?\"", gamelog);
            break;
        }
    ...
    case REJECTED_SECONDRATECLOTHES:
        ...
        case 1:
            addstr("\"That's a poor excuse for a uniform. Who are you?\"", gamelog);
            break;
        }
    ...
    case REJECTED_WEAPONS:
        ...
        if(metaldetect) {
            ...
            case 1:
                addstr("\"Hey, back off!\"", gamelog);
                break;

            case 2:
                addstr("\"Don't try anything!\"", gamelog);
                break;

            case 3:
                addstr("\"Are you here to make trouble?\"", gamelog);
                break;

            case 4:
                addstr("\"Stay back!\"", gamelog);
                break;
            }
    ...
    case NOT_REJECTED:
        ...
        case 2:
            addstr("\"Quiet day, today.\"", gamelog);
            break;

        case 3:
            addstr("\"Go on in.\"", gamelog);
            break;
        }
...
void special_oval_office(void) {
    ...
    if(sitealarm) {
        ...
        for(int e = 0; e < 6; e++)
            makecreature(encounter[e], CREATURE_SECRET_SERVICE);
