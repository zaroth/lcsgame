...
void special_bouncer_assess_squad() {
    ...
    if(!autoadmit) {
        ...
        case REJECTED_NUDE:
            ...
            case 3:
                addstr("\"No shoes, no shirt and you don't get service\"");
                break;
            }
...
void special_security(bool metaldetect) {
    ...
    case REJECTED_NUDE:
        ...
        if(autoadmit)
            ...
            case 0:
                addstr("\"Get out of here you nudist!!\"");
                break;

            case 1:
                addstr("\"Back off, creep!\"");
                break;

            case 2:
                addstr("\"Jesus!! Somebody call the cops!\"");
                break;

            case 3:
                addstr("\"Are you sleepwalking?!\"");
                break;
            }
    ...
    case REJECTED_UNDERAGE:
        ...
        switch(LCSrandom(4)) {
        case 0:
            addstr("\"No admittance, youngster.\"");
            break;

        case 1:
            addstr("\"You're too young to work here.\"");
            break;

        case 2:
            addstr("\"Go play someplace else.\"");
            break;
    ...
    case REJECTED_SMELLFUNNY:
        ...
        switch(LCSrandom(4)) {
        case 0:
            addstr("\"You don't work here, do you?\"");
            break;

        case 1:
            addstr("\"Hmm... can I see your badge?\"");
            break;
        ...
        case 3:
            addstr("\"You must be new. You'll need your badge.\"");
            break;
        }
    ...
    case REJECTED_BLOODYCLOTHES:
        ...
        case 1:
            addstr("\"Are you hurt?! The aid station is the other way!\"");
            break;

        case 2:
            addstr("\"Your clothes, that's blood!\"");
            break;

        case 3:
            addstr("\"Blood?! That's more than a little suspicious...\"");
            break;

        case 4:
            addstr("\"Did you just butcher a cat?!\"");
            break;

        case 5:
            addstr("\"Blood everywhere...?\"");
            break;
        }
    ...
    case REJECTED_DAMAGEDCLOTHES:
        ...
        case 1:
            addstr("\"Is that a damaged halloween costume?\"");
            break;
        }
    ...
    case REJECTED_SECONDRATECLOTHES:
        ...
        case 1:
            addstr("\"That's a poor excuse for a uniform. Who are you?\"");
            break;
        }
    ...
    case REJECTED_WEAPONS:
        ...
        if(metaldetect) {
            ...
            case 2:
                addstr("\"Don't try anything!\"");
                break;

            case 3:
                addstr("\"Are you here to make trouble?\"");
                break;
