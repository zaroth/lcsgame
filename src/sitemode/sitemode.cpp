                ...
                if(levelmap[locx][locy][locz].flag & SITEBLOCK_LOOT) {
                    ...
                    if(location[cursite]->siege.siege) {
                        ...
                        case SITE_RESIDENTIAL_TENEMENT:
                            ...
                            if(!LCSrandom(3))
                                item->loottype = LOOT_KIDART;
                            else if(!LCSrandom(2))
                                item->loottype = LOOT_DIRTYSOCK;
                            else
                                item->loottype = LOOT_FAMILYPHOTO;
                        ...
                        case SITE_RESIDENTIAL_APARTMENT:
                            ...
                            if(!LCSrandom(5))
                                item->loottype = LOOT_CELLPHONE;
                            else if(!LCSrandom(4))
                                item->loottype = LOOT_SILVERWARE;
                            else if(!LCSrandom(3))
                                item->loottype = LOOT_TRINKET;
                            else if(!LCSrandom(2))
                                item->loottype = LOOT_CHEAPJEWELERY;
                            else
                                item->loottype = LOOT_COMPUTER;
                        ...
                        case SITE_RESIDENTIAL_APARTMENT_UPSCALE:
                            ...
                            if(!LCSrandom(10))
                                item->loottype = LOOT_EXPENSIVEJEWELERY;
                            else if(!LCSrandom(5))
                                item->loottype = LOOT_CELLPHONE;
                            else if(!LCSrandom(4))
                                item->loottype = LOOT_SILVERWARE;
                            else if(!LCSrandom(3))
                                item->loottype = LOOT_PDA;
                            else if(!LCSrandom(2))
                                item->loottype = LOOT_CHEAPJEWELERY;
                            else
                                item->loottype = LOOT_COMPUTER;
                        ...
                        case SITE_LABORATORY_GENETIC:
                            ...
                            if(!LCSrandom(20))
                                item->loottype = LOOT_RESEARCHFILES;
                            else if(!LCSrandom(2))
                                item->loottype = LOOT_LABEQUIPMENT;
                            else if(!LCSrandom(2))
                                item->loottype = LOOT_COMPUTER;
                            else if(!LCSrandom(5))
                                item->loottype = LOOT_PDA;
                        ...
                        case SITE_GOVERNMENT_POLICESTATION:
                            ...
                            if(!LCSrandom(20))
                                item->loottype = LOOT_POLICERECORDS;
                            else if(!LCSrandom(3))
                                item->loottype = LOOT_CELLPHONE;
                            else if(!LCSrandom(2))
                                item->loottype = LOOT_PDA;
                        ...
                        case SITE_GOVERNMENT_INTELLIGENCEHQ:
                            ...
                            if(!LCSrandom(20))
                                item->loottype = LOOT_SECRETDOCUMENTS;
                            else if(!LCSrandom(3))
                                item->loottype = LOOT_CELLPHONE;
                            else if(!LCSrandom(2))
                                item->loottype = LOOT_PDA;
                        ...
                        case SITE_MEDIA_AMRADIO:
                            ...
                            if(!LCSrandom(20))
                                item->loottype = LOOT_AMRADIOFILES;
                            else if(!LCSrandom(4))
                                item->loottype = LOOT_MICROPHONE;
                            else if(!LCSrandom(3))
                                item->loottype = LOOT_PDA;
                            else if(!LCSrandom(2))
                                item->loottype = LOOT_CELLPHONE;
                        ...
                        case SITE_MEDIA_CABLENEWS:
                            ...
                            if(!LCSrandom(20))
                                item->loottype = LOOT_CABLENEWSFILES;
                            else if(!LCSrandom(4))
                                item->loottype = LOOT_MICROPHONE;
                            else if(!LCSrandom(3))
                                item->loottype = LOOT_PDA;
