...
char talk(Creature &a, int t) {
    ...
    if((sitealarm || location[cursite]->siege.siege) && encounter[t].enemy()) {
        ...
        while(1) {
            ...
            if(c == 'c' && encounter[t].cantbluff != 2)
                break;
                ...
                if(noretreat == false) {
                    ...
                    if(c == 'a') {
                        ...
                        if(((encounter[e].type == CREATURE_DEATHSQUAD ||
                            ...
                            switch(LCSrandom(4)) {
                            case 0:
                                addstr("\"Right. Let's do it.\"");
                                break;

                            case 1:
                                addstr("\"No further conditions.\"");
                                break;

                            case 2:
                                addstr("\"Let them go, and we're done.\"");
                                break;
    ...
    if(tk->type == CREATURE_GUARDDOG && tk->align != ALIGN_LIBERAL) {
        ...
        if(activesquad->squad[bestp]->get_attribute(ATTRIBUTE_HEART, true) >= 20) {
            switch(statement) {
            case 0:
                addstr("\"I love dogs more than people.\"");
                break;

            case 1:
                addstr("\"Dogs are the future of humanity.\"");
                break;

            case 2:
                addstr("\"Power to the canines!\"");
                break;

            case 3:
                addstr("\"We need to recruit more dogs.\"");
                break;

            case 4:
                addstr("\"Wanna join the LCS?\"");
                break;

            case 5:
                addstr("\"Want me to untie you?\"");
                break;

            case 6:
                addstr("\"You deserve better than this.\"");
                break;

            case 7:
                addstr("\"Dogs are the best anything ever.\"");
                break;

            case 8:
                addstr("\"We should bark together!\"");
                break;

            case 9:
                addstr("\"All we are saying is give fleas a chance.\"");
                break;

            case 10:
                addstr("\"Dogs are better than humans.\"");
                break;
            }
        } else { // or not
            switch(statement) {
            case 0:
                addstr("\"Hi Mister Dog!\"");
                break;
        ...
        if(activesquad->squad[bestp]->get_attribute(ATTRIBUTE_HEART, true) >= 20) {
            ...
            switch(statement) {
            case 0:
                addstr("\"A human after my own heart, in more ways than one.\"");
                break;

            case 1:
                addstr("\"I don't see it, but I'll hear you out.\"");
                break;

            case 2:
                addstr("\"Down with the feline establishment!\"");
                break;

            case 3:
                addstr("\"Oh yeah? I'm a dog. What do you represent?\"");
                break;

            case 4:
                addstr("\"Maybe. Is there a dental plan?\"");
                break;

            case 5:
                addstr("\"Yes, please! This collar is painful!\"");
                break;

            case 6:
                addstr("\"Finally, a human that understands.\"");
                break;

            case 7:
                addstr("\"Heheheh, you're funny. Okay, I won't rat you out.\"");
                break;

            case 8:
                addstr("\"Barkety bark, baby. Tell me more.\"");
                break;

            case 9:
                addstr("\"We'll fight the fleas until our dying itch.\"");
                break;

            case 10:
                addstr("\"You're pandering, but I love it.\"");
                break;
            }
            ...
            case 10:
                addstr("\"Your accent is atrocious.\"");
                break;
            }
        ...
        if(c >= 'a' && c <= 'g') {
            ...
            case TALKMODE_ISSUES: {
                ...
                if(you_are_stupid) {
                    ...
                    case LAW_TORTURE:
                        addstr("\"Some conservatives support torture.\"");
                        break;
                    }
                } else {
                    switch(lw) {
                    ...
                    if(tk->type == CREATURE_MUTANT &&
                        ...
                        if(tk->align == ALIGN_CONSERVATIVE && you_are_stupid) {
                            ...
                            if(tk->type == CREATURE_GANGUNIT)
                                ...
                                switch(LCSrandom(10)) {
                                case 0:
                                    addstr("\"Get away from me, you hippie.\"");
                                    break;

                                case 1:
                                    addstr("\"My heart aches for humanity.\"");
                                    break;

                                case 2:
                                    addstr("\"I'm sorry, but I think I'm done talking to you.\"");
                                    break;

                                case 3:
                                    addstr("\"Do you need some help finding the exit?\"");
                                    break;

                                case 4:
                                    addstr("\"People like you are the reason I'm on medication.\"");
                                    break;

                                case 5:
                                    addstr("\"Everyone is entitled to be stupid, but you abuse the privilege.\"");
                                    break;

                                case 6:
                                    addstr("\"I don't know what you're on, but I hope it's illegal.\"");
                                    break;

                                case 7:
                                    addstr("\"Don't you have a parole meeting to get to?\"");
                                    break;

                                case 8:
                                    addstr("\"Wow. Why am I talking to you again?\"");
                                    break;

                                case 9:
                                    addstr("\"Were you dropped as a child?\"");
                                    break;
                                }
                            }
                            ...
                            case LAW_TAX:
                                addstr("\"I want to pay lower taxes.\"");
                                break;
                            ...
                            case LAW_IMMIGRATION:
                                addstr("\"Immigration undermines our economy and culture.\"");
                                break;
