...
char hasdisguise(Creature &cr) {
    ...
    if(location[cursite]->siege.siege) {
        ...
        case SIEGE_HICKS: {
            if(cr.get_armor().get_itemtypename() == "ARMOR_CLOTHES")
                uniformed = 2;

            if(cr.get_armor().get_itemtypename() == "ARMOR_OVERALLS")
                uniformed = 1;

            if(cr.get_armor().get_itemtypename() == "ARMOR_WIFEBEATER")
                uniformed = 1;
        ...
        case SIEGE_FIREMEN: {
            if(cr.get_armor().get_itemtypename() == "ARMOR_BUNKERGEAR")
                uniformed = 1;
        ...
        if((!cr.is_naked() || cr.animalgloss == ANIMALGLOSS_ANIMAL)
                && cr.get_armor().get_itemtypename() != "ARMOR_HEAVYARMOR")
            uniformed = 1;
        ...
        case SITE_GOVERNMENT_COURTHOUSE:
            if(levelmap[locx][locy][locz].flag & SITEBLOCK_RESTRICTED) {
                ...
                if(cr.get_armor().get_itemtypename() == "ARMOR_BLACKROBE")
                    uniformed = 1;
        ...
        case SITE_GOVERNMENT_PRISON:
            if(levelmap[locx][locy][locz].flag & SITEBLOCK_RESTRICTED) {
                ...
                if(law[LAW_DEATHPENALTY] == -2 &&
                    ...
                    if(cr.get_armor().get_itemtypename() == "ARMOR_LABCOAT")
                        uniformed = 1;
                } else if(cr.get_armor().get_itemtypename() == "ARMOR_PRISONGUARD")
                    uniformed = 1;

                if(cr.get_armor().get_itemtypename() == "ARMOR_PRISONER")
                    uniformed = 1;
            }
        ...
        case SITE_GOVERNMENT_ARMYBASE:
            if(levelmap[locx][locy][locz].flag & SITEBLOCK_RESTRICTED) {
                ...
                if(cr.get_armor().get_itemtypename() == "ARMOR_ARMYUNIFORM")
                    uniformed = 1;
        ...
        case SITE_GOVERNMENT_FIRESTATION:
            if(levelmap[locx][locy][locz].flag & SITEBLOCK_RESTRICTED) {
                ...
                if(cr.get_armor().get_itemtypename() == "ARMOR_WORKCLOTHES")
                    uniformed = 1;
        ...
        case SITE_CORPORATE_HOUSE:
            ...
            if(cr.get_armor().get_itemtypename() == "ARMOR_SERVANTUNIFORM")
                uniformed = 1;
