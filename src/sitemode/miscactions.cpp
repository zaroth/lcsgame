...
char radio_broadcast(void) {
    ...
    if(segmentpower < 25)
        addstr("The Squad sounds wholly insane.", gamelog);
    else if(segmentpower < 35)
        addstr("The show really sucks.", gamelog);
    else if(segmentpower < 45)
        addstr("It is a very boring hour.", gamelog);
    else if(segmentpower < 55)
        addstr("It is mediocre radio.", gamelog);
    else if(segmentpower < 70)
        addstr("The show was all right.", gamelog);
    else if(segmentpower < 85)
        addstr("The Squad put on a good show.", gamelog);
    else if(segmentpower < 100)
        addstr("It was thought-provoking, even humorous.", gamelog);
    else
        addstr("It was the best hour of AM radio EVER.", gamelog);
...
char news_broadcast(void) {
    ...
    if(segmentpower < 25)
        addstr("The Squad looks completely insane.", gamelog);
    else if(segmentpower < 35)
        addstr("The show really sucks.", gamelog);
    else if(segmentpower < 45)
        addstr("It is a very boring hour.", gamelog);
    else if(segmentpower < 55)
        addstr("It is mediocre TV.", gamelog);
    else if(segmentpower < 70)
        addstr("The show was all right.", gamelog);
    else if(segmentpower < 85)
        addstr("The Squad put on a good show.", gamelog);
        ...
        addstr("It was the best hour of Cable TV EVER.", gamelog);
