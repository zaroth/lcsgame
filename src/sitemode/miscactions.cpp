...
char hack(short type, char &actual) {
    ...
    if(hacker > -1) {
        ...
        if(maxattack > difficulty) {
            ...
            case HACK_VAULT:
                addstr(" has disabled the second layer of security!");
                break;
            }
            ...
            case HACK_VAULT:
                addstr(" couldn't bypass the vault's electronic lock.");
                break;
            }
...
char radio_broadcast(void) {
    ...
    switch(viewhit) {
    case VIEW_GAY:
        addstr("discusses homosexual rights.");
        break;

    case VIEW_DEATHPENALTY:
        addstr("examines the death penalty.");
        break;

    case VIEW_TAXES:
        addstr("discusses the tax code.");
        break;

    case VIEW_NUCLEARPOWER:
        addstr("runs down nuclear power.");
        break;

    case VIEW_ANIMALRESEARCH:
        addstr("discusses the horrors of animal research.");
        break;
    ...
    case VIEW_INTELLIGENCE:
        addstr("debates privacy law.");
        break;

    case VIEW_FREESPEECH:
        addstr("talks about free speech.");
        break;

    case VIEW_GENETICS:
        addstr("discusses the implications of genetic research.");
        break;

    case VIEW_JUSTICES:
        addstr("talks about the record of a Conservative judge.");
        break;

    case VIEW_GUNCONTROL:
        addstr("talks about gun control.");
        break;

    case VIEW_SWEATSHOPS:
        addstr("brings details about sweatshops to light.");
        break;

    case VIEW_POLLUTION:
        addstr("does a show on industrial pollution.");
        break;

    case VIEW_CORPORATECULTURE:
        addstr("jokes about corporate culture.");
        break;

    case VIEW_CEOSALARY:
        addstr("gives examples of CEO excesses.");
        break;
    ...
    case VIEW_AMRADIO:
        addstr("discusses other AM radio shows.");
        break;

    case VIEW_CABLENEWS:
        addstr("talks about Cable News.");
        break;
    ...
    case VIEW_CONSERVATIVECRIMESQUAD:
        addstr("demonizes the Conservative Crime Squad.");
        break;
    }
        ...
        if(activesquad->squad[p] != NULL) {
            if(activesquad->squad[p]->prisoner != NULL && activesquad->squad[p]->prisoner->alive) {
                if(activesquad->squad[p]->prisoner->type == CREATURE_RADIOPERSONALITY) {
                    ...
                    switch(viewhit) {
                    case VIEW_GAY:
                        addstr("discuss homosexual rights.");
                        break;

                    case VIEW_DEATHPENALTY:
                        addstr("examine the death penalty.");
                        break;

                    case VIEW_TAXES:
                        addstr("discuss the tax code.");
                        break;

                    case VIEW_NUCLEARPOWER:
                        addstr("run down nuclear power.");
                        break;

                    case VIEW_ANIMALRESEARCH:
                        addstr("discuss the horrors of animal research.");
                        break;
                    ...
                    case VIEW_INTELLIGENCE:
                        addstr("debate privacy law.");
                        break;

                    case VIEW_FREESPEECH:
                        addstr("talk about free speech.");
                        break;

                    case VIEW_GENETICS:
                        addstr("discuss the implications of genetic research.");
                        break;

                    case VIEW_JUSTICES:
                        addstr("talk about the record of a Conservative judge.");
                        break;

                    case VIEW_GUNCONTROL:
                        addstr("talk about gun control.");
                        break;

                    case VIEW_SWEATSHOPS:
                        addstr("bring details about sweatshops to light.");
                        break;

                    case VIEW_POLLUTION:
                        addstr("do a show on industrial pollution.");
                        break;

                    case VIEW_CORPORATECULTURE:
                        addstr("joke about corporate culture.");
                        break;

                    case VIEW_CEOSALARY:
                        addstr("give examples of CEO excesses.");
                        break;
                    ...
                    case VIEW_DRUGS:
                        addstr("have a frank talk about drugs.");
                        break;

                    case VIEW_IMMIGRATION:
                        addstr("examine the issue of immigration.");
                        break;

                    case VIEW_MILITARY:
                        addstr("talk about militarism in modern culture.");
                        break;

                    case VIEW_AMRADIO:
                        addstr("discuss other AM radio shows.");
                        break;

                    case VIEW_CABLENEWS:
                        addstr("talk about Cable News.");
                        break;

                    case VIEW_LIBERALCRIMESQUAD:
                        addstr("let people know about the Liberal Crime Squad.");
                        break;

                    default:
                    case VIEW_LIBERALCRIMESQUADPOS:
                        addstr("extol the virtues of the Liberal Crime Squad.");
                        break;

                    case VIEW_CONSERVATIVECRIMESQUAD:
                        addstr("demonize the Conservative Crime Squad.");
                        break;
                    }
...
void partyrescue(short special) {
    ...
    for(pl = 0; pl < pool.size(); pl++) {
        if(pool[pl]->location == cursite &&
                ...
                //Low is for normal time-limited sentences.
            ...
            for(int p = 0; p < 6; p++) {
                if(activesquad->squad[p] != NULL) {
                    if(activesquad->squad[p]->alive && activesquad->squad[p]->prisoner == NULL) {
                        ...
                        switch(LCSrandom(3)) {
                        case 0:
                            addstr("was tortured recently");
                            break;

                        case 1:
                            addstr("was beaten severely yesterday");
                            break;

                        case 2:
                            addstr("was on a hunger strike");
                            break;
                        }
