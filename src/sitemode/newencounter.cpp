...
void prepareencounter(int16 type, char sec) {
    ...
    case SITE_LABORATORY_GENETIC: {
        if(sec)
            creaturearray[CREATURE_SECURITYGUARD] = 10000;
        else
            creaturearray[CREATURE_SECURITYGUARD] = 1000;
    ...
    case SITE_INDUSTRY_POLLUTER: {
        ...
        if(law[LAW_LABOR] == -2) {
            ...
            creaturearray[CREATURE_WORKER_FACTORY_UNION] = 1600;
    ...
    case SITE_CORPORATE_HEADQUARTERS: {
        if(sec)
            creaturearray[CREATURE_SECURITYGUARD] = 4000;
        else
