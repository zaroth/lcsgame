    ...
    if(postalarmtimer > 80) {
        ...
        case SITE_GOVERNMENT_POLICESTATION:
            if(law[LAW_DEATHPENALTY] == -2 &&
                ...
                creaturearray[CREATURE_SWAT] = 1000;
        ...
        if(siteonfire && law[LAW_FREESPEECH] != -2)
    ...
    if(location[cursite]->renting == RENTING_CCS) {
        ...
        case SITE_BUSINESS_CRACKHOUSE: {
            ...
            if(law[LAW_NUCLEARPOWER] == -2)
                creaturearray[CREATURE_MUTANT] += 2;
        ...
        case SITE_BUSINESS_CIGARBAR: {
            if(sec || sitealarm == 1)
                ...
                creaturearray[CREATURE_BOUNCER] += 10;

            if(sec)
                creaturearray[CREATURE_GUARDDOG] += 25;
        ...
        case SITE_GOVERNMENT_WHITE_HOUSE: {
            ...
            if(sec)
                creaturearray[CREATURE_SECRET_SERVICE] += 100;
            else
                creaturearray[CREATURE_SECRET_SERVICE] += 5;
        ...
        case SITE_BUSINESS_LATTESTAND: {
            ...
            if(law[LAW_NUCLEARPOWER] == -2)
                creaturearray[CREATURE_MUTANT] += 1;
            ...
            if(law[LAW_DEATHPENALTY] == -2 &&
                    law[LAW_POLICEBEHAVIOR] == -2)
                creaturearray[CREATURE_EDUCATOR] += 1;
            else
                creaturearray[CREATURE_PRISONGUARD] += 1;
        ...
        case SITE_RESIDENTIAL_TENEMENT: {
            ...
            if(law[LAW_POLLUTION] == -2 &&
                    law[LAW_NUCLEARPOWER] == -2)
                creaturearray[CREATURE_MUTANT] += 5;
        ...
        case SITE_BUSINESS_BANK: {
            if(mode == GAMEMODE_SITE && !(levelmap[locx][locy][locz].flag & SITEBLOCK_RESTRICTED)) {
                if(sec)
                    ...
                    creaturearray[CREATURE_SECURITYGUARD] = 50;
        ...
        case SITE_LABORATORY_COSMETICS: {
            if(sec)
                ...
                creaturearray[CREATURE_SECURITYGUARD] += 3;
        ...
        case SITE_GOVERNMENT_INTELLIGENCEHQ: {
            ...
            if(sec)
                creaturearray[CREATURE_GUARDDOG] += 450;
        ...
        case SITE_CORPORATE_HEADQUARTERS: {
            ...
            if(sec)
                ...
                creaturearray[CREATURE_SECURITYGUARD] = 40;
        ...
        case SITE_CORPORATE_HOUSE: {
            ...
            if(sec)
                ...
                creaturearray[CREATURE_GUARDDOG] = 5;
                ...
                case SIEGE_POLICE:
                    if(location[cursite]->siege.escalationstate == 0)
                        ...
                        if (location[cursite]->siege.escalationstate < 3)
                            ...
                            makecreature(encounter[e], CREATURE_SEAL);
                    }
