        ...
        if (element == "year") {
            ...
            while (xmlfile.FindElem()) {
                ...
                if (element == "start_at_current_year") {
                    ...
                    year_start_ = atoi(xmlfile.GetData().c_str());
                    ...
                    year_addrandom_ = atoi(xmlfile.GetData().c_str());
                else if (element == "add")
                    year_add_ = atoi(xmlfile.GetData().c_str());
            ...
            drivebonus_ = atoi(xmlfile.GetData().c_str());
            ...
            while (xmlfile.FindElem()) {
                ...
                if (element == "difficulty_to_find")
                    steal_difficultytofind_ = atoi(xmlfile.GetData().c_str());
                else if (element == "juice")
                    steal_juice_ = atoi(xmlfile.GetData().c_str());
                else if (element == "extra_heat")
                    steal_extraheat_ = atoi(xmlfile.GetData().c_str());
                else if (element == "sense_alarm_chance")
                    sensealarmchance_ = atoi(xmlfile.GetData().c_str());
                else if (element == "touch_alarm_chance")
                    touchalarmchance_ = atoi(xmlfile.GetData().c_str());
