...
void readMapCBSpecials(int x, int y, int z, int i) {
    ...
    case 3:
        levelmap[x][y][z].special = SPECIAL_POLICESTATION_LOCKUP;
        break;

    case 4:
        levelmap[x][y][z].special = SPECIAL_COURTHOUSE_LOCKUP;
        break;

    case 5:
        levelmap[x][y][z].special = SPECIAL_COURTHOUSE_JURYROOM;
        break;

    case 6:
        levelmap[x][y][z].special = SPECIAL_PRISON_CONTROL;
        break;

    case 7:
        levelmap[x][y][z].special = SPECIAL_PRISON_CONTROL_LOW;
        break;

    case 8:
        levelmap[x][y][z].special = SPECIAL_PRISON_CONTROL_MEDIUM;
        break;

    case 9:
        levelmap[x][y][z].special = SPECIAL_PRISON_CONTROL_HIGH;
        break;

    case 10:
        levelmap[x][y][z].special = SPECIAL_INTEL_SUPERCOMPUTER;
        break;
    ...
    case 13:
        levelmap[x][y][z].special = SPECIAL_NUCLEAR_ONOFF;
        break;

    case 14:
        levelmap[x][y][z].special = SPECIAL_HOUSE_PHOTOS;
        break;

    case 15:
        levelmap[x][y][z].special = SPECIAL_HOUSE_CEO;
        break;

    case 16:
        levelmap[x][y][z].special = SPECIAL_CORPORATE_FILES;
        break;

    case 17:
        levelmap[x][y][z].special = SPECIAL_RADIO_BROADCASTSTUDIO;
        break;

    case 18:
        levelmap[x][y][z].special = SPECIAL_NEWS_BROADCASTSTUDIO;
        break;

    case 19:
        levelmap[x][y][z].special = SPECIAL_APARTMENT_LANDLORD;
        break;

    case 20:
        levelmap[x][y][z].special = SPECIAL_SIGN_ONE;
        break;
    ...
    case 25:
        levelmap[x][y][z].special = SPECIAL_STAIRS_DOWN;
        break;

    case 26:
        levelmap[x][y][z].special = SPECIAL_CLUB_BOUNCER;
        break;

    case 27:
        levelmap[x][y][z].special = SPECIAL_CLUB_BOUNCER_SECONDVISIT;
        break;

    case 28:
        levelmap[x][y][z].special = SPECIAL_ARMORY;
        break;

    case 29:
        levelmap[x][y][z].special = SPECIAL_DISPLAY_CASE;
        break;

    case 30:
        levelmap[x][y][z].special = SPECIAL_SIGN_TWO;
        break;

    case 31:
        levelmap[x][y][z].special = SPECIAL_SIGN_THREE;
        break;

    case 32:
        levelmap[x][y][z].special = SPECIAL_SECURITY_CHECKPOINT;
        break;

    case 33:
        levelmap[x][y][z].special = SPECIAL_SECURITY_METALDETECTORS;
        break;

    case 34:
        levelmap[x][y][z].special = SPECIAL_SECURITY_SECONDVISIT;
        break;

    case 35:
        levelmap[x][y][z].special = SPECIAL_BANK_VAULT;
        break;

    case 36:
        levelmap[x][y][z].special = SPECIAL_BANK_TELLER;
        break;

    case 37:
        levelmap[x][y][z].special = SPECIAL_BANK_MONEY;
        break;

    case 38:
        levelmap[x][y][z].special = SPECIAL_CCS_BOSS;
        break;

    case 39:
        levelmap[x][y][z].special = SPECIAL_OVAL_OFFICE_NW;
        break;

    case 40:
        levelmap[x][y][z].special = SPECIAL_OVAL_OFFICE_NE;
        break;

    case 41:
        levelmap[x][y][z].special = SPECIAL_OVAL_OFFICE_SW;
        break;

    case 42:
        levelmap[x][y][z].special = SPECIAL_OVAL_OFFICE_SE;
        break;
    }
}
...
bool readMap(const char *filename) {
    ...
    if(!readMapFile((prefix + filename + "_Tiles.csv").c_str(), 0, readMapCBTiles))
        return false;

    if(!readMapFile((prefix + filename + "_Specials.csv").c_str(), 0, readMapCBSpecials))
        return false;
    ...
    for(z = 1; z < MAPZ; z++) {
        ...
        if(!readMapFile((prefix + filename + str + "_Tiles.csv").c_str(), z, readMapCBTiles))
            break;

        if(!readMapFile((prefix + filename + str + "_Specials.csv").c_str(), z, readMapCBSpecials))
            break;
    }
