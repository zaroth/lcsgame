...
void makecharacter(void) {
    ...
    for(int q = 0; q < 10; q++) {
        ...
        case 0:
            move(2, 0);
            addstr("The day I was born in 1984...");
            move(5, 0);
            addstr("A - was the day the Sandinista Front won the elections in Nicaragua.");
            ...
            //ATTRIBUTE_HEALTH 1
            move(9, 0);
            addstr("C - was the day the Macintosh was introduced.");
        ...
        case 1:
            move(2, 0);
            addstr("When I was bad...");
            move(5, 0);
            addstr("A - my parents argued with each other about me, but I was never punished.");
            //SKILL_PERSUASION 1
            //ATTRIBUTE_CHARISMA 2
            move(7, 0);
        ...
        case 2:
            move(2, 0);
            addstr("In elementary school...");
            move(5, 0);
            addstr("A - I was the class clown.  I even had some friends.");
            //SKILL_PERSUASION 2
            //ATTRIBUTE_CHARISMA 1
            move(7, 0);
            addstr("B - I was unruly and often fought with the other children.");
            //SKILL_HANDTOHAND 1
            //ATTRIBUTE_STRENGTH 1
            //ATTRIBUTE_AGILITY 1
            move(9, 0);
        ...
        case 3:
            move(2, 0);
            addstr("When I turned 10...");
            move(5, 0);
            addstr("A - my parents divorced.  Acrimoniously.  I once tripped over the paperwork!");
            //ATTRIBUTE_INTELLIGENCE 1
            //SKILL_WRITING 1
            //SKILL_LAW 1
            move(7, 0);
            ...
            //ATTRIBUTE_AGILITY 1
            move(9, 0);
            addstr("C - my parents divorced.  My studies suffered but I continued working.");
        ...
        case 4:
            move(2, 0);
            addstr("When I hit junior high school...");
            move(5, 0);
            addstr("A - I broke into lockers and was into punk rock.");
            //SKILL_SECURITY 1
            //ATTRIBUTE_CHARISMA 1
            move(7, 0);
            addstr("B - I was into knives and broke things with bats.  My anger was unmanaged.");
            //SKILL_KNIFE 1
            //SKILL_CLUB 1
            move(9, 0);
            addstr("C - I got into chess and go.  I was a total outcast.");
            //ATTRIBUTE_INTELLIGENCE 2
            break;

        case 5:
            move(2, 0);
            addstr("Things were getting really bad...");
            move(5, 0);
        ...
        case 6:
            move(2, 0);
            addstr("Well, I knew it had reached a crescendo when...");
            move(5, 0);
            ...
            move(7, 0);
            addstr("B - my mom shot her ex-husband, my dad, with a shotgun.  She got off.");
            //SKILL_RIFLE 1
            //SKILL_ASSAULTRIFLE 1
            //SKILL_PISTOL 1
            move(9, 0);
            addstr("C - I tried sports for a quarter, desperate to fit in.");
            //ATTRIBUTE_STRENGTH 1
            //ATTRIBUTE_AGILITY 2
            break;
        ...
        case 7:
            move(2, 0);
            addstr("I was only 15 when I ran away, and...");
            move(5, 0);
            ...
            //SKILL_HANDTOHAND 1
            move(9, 0);
            addstr("C - I volunteered for a left-wing candidate. It wasn't *real*, though, you know?");
            //ATTRIBUTE_HEART 1
            //SKILL_LAW 1
            //SKILL_PERSUASION 1
            break;
        ...
        case 8:
            move(2, 0);
            addstr("Life went on.  On my 18th birthday...");
            move(5, 0);
        ...
        case 9:
            move(2, 0);
            addstr("For the past few years, I've been...");
            move(5, 0);
            addstr("A - stealing from Corporations, but I want to do more.");
            //ATTRIBUTE_INTELLIGENCE 2
            //ATTRIBUTE_AGILITY 1
            //ATTRIBUTE_CHARISMA 1
            //SKILL_DISGUISE 2
            ...
            //SKILL_DRIVING 1
            move(7, 0);
            addstr("B - a violent criminal.  Nothing can change that.");
            //SKILL_RIFLE 1
            //SKILL_ASSAULTRIFLE 1
            //SKILL_PISTOL 1
            //SKILL_KNIFE 1
            ...
            //ATTRIBUTE_HEALTH 1
            move(9, 0);
            addstr("C - volunteering for prominent liberals, but I know there's a better way.");
            //ATTRIBUTE_INTELLIGENCE 2
            //ATTRIBUTE_HEART 2
            //SKILL_LAW 2
            //SKILL_WRITING 2
