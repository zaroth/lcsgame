...
void youattack(void) {
    ...
    for(int p = 0; p < 6; p++) {
        ...
        if(dangerous_enemies.size() + enemies.size() == 0)
            return;
    ...
    for(e = 0; e < ENCMAX; e++) {
        ...
        if(encounter[e].enemy()) {
            ...
            for(e2 = 0; e2 < ENCMAX; e2++) {
                if(!encounter[e2].exists)
                    continue;

                if(!encounter[e2].alive)
                    continue;

                if(encounter[e2].align != -1)
                    continue;
        ...
        if((encounter[e].type == CREATURE_SCIENTIST_EMINENT ||
                ...
                encounter[e].type == CREATURE_MILITARYOFFICER) && encnum < ENCMAX)
            canmistake = 0;
                    ...
                    if(!activesquad->squad[target]->prisoner->alive) {
                        if(activesquad->squad[target]->prisoner->squadid == -1) {
                            ...
                            if(activesquad->squad[target]->prisoner->type == CREATURE_CORPORATE_CEO ||
                                    ...
                                    activesquad->squad[target]->prisoner->type == CREATURE_MILITARYOFFICER)
                                sitecrime += 30;
    ...
    if(aroll + bonus > droll) {
        ...
        if(t.animalgloss == ANIMALGLOSS_TANK) {
            ...
            case BODYPART_ARM_RIGHT:
                strcat(str, "right side");
                break;

            case BODYPART_ARM_LEFT:
                strcat(str, "left side");
                break;

            case BODYPART_LEG_RIGHT:
                strcat(str, "right tread");
                break;
            ...
            case BODYPART_ARM_RIGHT:
                strcat(str, "right front leg");
                break;

            case BODYPART_ARM_LEFT:
                strcat(str, "left front leg");
                break;

            case BODYPART_LEG_RIGHT:
                strcat(str, "right rear leg");
                break;

            case BODYPART_LEG_LEFT:
                strcat(str, "left rear leg");
                break;
            }
        } else {
            switch(w) {
        ...
        if(bursthits > 1 && a.is_armed()) { // Only show if not melee
            ...
            case 3:
                strcat(str, " three times");
                break;

            case 4:
                strcat(str, " four times");
                break;

            case 5:
                strcat(str, " five times");
                break;
        ...
        if(damamount > 0) {
            ...
            if(!target)
                target = &t;  //If nobody jumps in front of the attack,
            ...
            if(damagearmor)
                armordamage(target->get_armor(), w);
            ...
            if((target->wound[BODYPART_HEAD] & WOUND_CLEANOFF) ||
                ...
                if(!alreadydead) {
                    ...
                    if(target->squadid != -1) {
                        ...
                        if(location[cursite]->renting == RENTING_CCS) {
                            if(target->type == CREATURE_CCS_ARCHCONSERVATIVE)
                                ccs_boss_kills++;
                ...
                if(!(target->wound[w] & (WOUND_CLEANOFF | WOUND_NASTYOFF)) &&
                    ...
                    if(damamount >= 12) { //JDS -- 2x damage needed
                        ...
                        if(damtype & WOUND_TORN)
                            heavydam = 1;

                        if(damtype & WOUND_CUT)
                            heavydam = 1;
                    }
                    ...
                    if((damtype & WOUND_BRUISED) && damamount >= 50)
                        breakdam = 1;

                    if((damtype & WOUND_SHOT) && damamount >= 50)
                        breakdam = 1;

                    if((damtype & WOUND_TORN) && damamount >= 50)
                        breakdam = 1;

                    if((damtype & WOUND_CUT) && damamount >= 50)
                        breakdam = 1;
                    ...
                    if(w == BODYPART_HEAD) {
                        ...
                        case 0:
                            if((target->special[SPECIALWOUND_RIGHTEYE] ||
                                ...
                                if(damtype & WOUND_SHOT)
                                    addstr("'s face is blasted off!", gamelog);
                                else if(damtype & WOUND_BURNED)
                                    addstr("'s face is burned away!", gamelog);
                                else if(damtype & WOUND_TORN)
                                    addstr("'s face is torn off!", gamelog);
                                else if(damtype & WOUND_CUT)
                                    addstr("'s face is cut away!", gamelog);
                                else
                                    addstr("'s face is removed!", gamelog);
                        ...
                        case 1:
                            if(target->special[SPECIALWOUND_TEETH] > 0) {
                                ...
                                if(damtype & WOUND_SHOT)
                                    addstr("shot out!", gamelog);
                                else if(damtype & WOUND_BURNED)
                                    addstr("burned away!", gamelog);
                                else if(damtype & WOUND_TORN)
                                    addstr("gouged out!", gamelog);
                                else if(damtype & WOUND_CUT)
                                    addstr("cut out!", gamelog);
                                else
                                    addstr("knocked out!", gamelog);
                        ...
                        case 2:
                            if(target->special[SPECIALWOUND_RIGHTEYE] &&
                                ...
                                if(damtype & WOUND_SHOT)
                                    addstr("'s right eye is blasted out!", gamelog);
                                else if(damtype & WOUND_BURNED)
                                    addstr("'s right eye is burned away!", gamelog);
                                else if(damtype & WOUND_TORN)
                                    addstr("'s right eye is torn out!", gamelog);
                                else if(damtype & WOUND_CUT)
                                    addstr("'s right eye is poked out!", gamelog);
                                else
                                    addstr("'s right eye is removed!", gamelog);
                        ...
                        case 3:
                            if(target->special[SPECIALWOUND_LEFTEYE] && heavydam) {
                                ...
                                if(damtype & WOUND_SHOT)
                                    addstr("'s left eye is blasted out!", gamelog);
                                else if(damtype & WOUND_BURNED)
                                    addstr("'s left eye is burned away!", gamelog);
                                else if(damtype & WOUND_TORN)
                                    addstr("'s left eye is torn out!", gamelog);
                                else if(damtype & WOUND_CUT)
                                    addstr("'s left eye is poked out!", gamelog);
                                else
                                    addstr("'s left eye is removed!", gamelog);
                        ...
                        case 4:
                            if(target->special[SPECIALWOUND_TONGUE] && heavydam) {
                                ...
                                if(damtype & WOUND_SHOT)
                                    addstr("'s tongue is blasted off!", gamelog);
                                else if(damtype & WOUND_BURNED)
                                    addstr("'s tongue is burned away!", gamelog);
                                else if(damtype & WOUND_TORN)
                                    addstr("'s tongue is torn out!", gamelog);
                                else if(damtype & WOUND_CUT)
                                    addstr("'s tongue is cut off!", gamelog);
                                else
                                    addstr("'s tongue is removed!", gamelog);
                        ...
                        case 5:
                            if(target->special[SPECIALWOUND_NOSE] &&
                                ...
                                if(damtype & WOUND_SHOT)
                                    addstr("'s nose is blasted off!", gamelog);
                                else if(damtype & WOUND_BURNED)
                                    addstr("'s nose is burned away!", gamelog);
                                else if(damtype & WOUND_TORN)
                                    addstr("'s nose is torn off!", gamelog);
                                else if(damtype & WOUND_CUT)
                                    addstr("'s nose is cut off!", gamelog);
                                else
                                    addstr("'s nose is removed!", gamelog);
                        ...
                        case 6:
                            if(target->special[SPECIALWOUND_NECK] &&
                                ...
                                if(damtype & WOUND_SHOT)
                                    addstr("'s neck bones are shattered!", gamelog);
                                else
                                    addstr("'s neck is broken!", gamelog);
                    ...
                    if(w == BODYPART_BODY) {
                        ...
                        case 0:
                            if(target->special[SPECIALWOUND_UPPERSPINE] &&
                                ...
                                if(damtype & WOUND_SHOT)
                                    addstr("'s upper spine is shattered!", gamelog);
                                else
                                    addstr("'s upper spine is broken!", gamelog);
                        ...
                        case 1:
                            if(target->special[SPECIALWOUND_LOWERSPINE] &&
                                ...
                                if(damtype & WOUND_SHOT)
                                    addstr("'s lower spine is shattered!", gamelog);
                                else
                                    addstr("'s lower spine is broken!", gamelog);
                        ...
                        case 2:
                            if(target->special[SPECIALWOUND_RIGHTLUNG] &&
                                ...
                                if(damtype & WOUND_SHOT)
                                    addstr("'s right lung is blasted!", gamelog);
                                else if(damtype & WOUND_TORN)
                                    addstr("'s right lung is torn!", gamelog);
                                else
                                    addstr("'s right lung is punctured!", gamelog);
                        ...
                        case 3:
                            if(target->special[SPECIALWOUND_LEFTLUNG] &&
                                ...
                                if(damtype & WOUND_SHOT)
                                    addstr("'s left lung is blasted!", gamelog);
                                else if(damtype & WOUND_TORN)
                                    addstr("'s left lung is torn!", gamelog);
                                else
                                    addstr("'s left lung is punctured!", gamelog);
                        ...
                        case 4:
                            if(target->special[SPECIALWOUND_HEART] &&
                                ...
                                if(damtype & WOUND_SHOT)
                                    addstr("'s heart is blasted!", gamelog);
                                else if(damtype & WOUND_TORN)
                                    addstr("'s heart is torn!", gamelog);
                                else
                                    addstr("'s heart is punctured!", gamelog);
                        ...
                        case 5:
                            if(target->special[SPECIALWOUND_LIVER] &&
                                ...
                                if(damtype & WOUND_SHOT)
                                    addstr("'s liver is blasted!", gamelog);
                                else if(damtype & WOUND_TORN)
                                    addstr("'s liver is torn!", gamelog);
                                else
                                    addstr("'s liver is punctured!", gamelog);
                        ...
                        case 6:
                            if(target->special[SPECIALWOUND_STOMACH] &&
                                ...
                                if(damtype & WOUND_SHOT)
                                    addstr("'s stomach is blasted!", gamelog);
                                else if(damtype & WOUND_TORN)
                                    addstr("'s stomach is torn!", gamelog);
                                else
                                    addstr("'s stomach is punctured!", gamelog);
                        ...
                        case 7:
                            if(target->special[SPECIALWOUND_RIGHTKIDNEY] &&
                                ...
                                if(damtype & WOUND_SHOT)
                                    addstr("'s right kidney is blasted!", gamelog);
                                else if(damtype & WOUND_TORN)
                                    addstr("'s right kidney is torn!", gamelog);
                                else
                                    addstr("'s right kidney is punctured!", gamelog);
                        ...
                        case 8:
                            if(target->special[SPECIALWOUND_LEFTKIDNEY] &&
                                ...
                                if(damtype & WOUND_SHOT)
                                    addstr("'s left kidney is blasted!", gamelog);
                                else if(damtype & WOUND_TORN)
                                    addstr("'s left kidney is torn!", gamelog);
                                else
                                    addstr("'s left kidney is punctured!", gamelog);
                        ...
                        case 9:
                            if(target->special[SPECIALWOUND_SPLEEN] &&
                                ...
                                if(damtype & WOUND_SHOT)
                                    addstr("'s spleen is blasted!", gamelog);
                                else if(damtype & WOUND_TORN)
                                    addstr("'s spleen is torn!", gamelog);
                                else
                                    addstr("'s spleen is punctured!", gamelog);
                        ...
                        case 10:
                            if(target->special[SPECIALWOUND_RIBS] > 0 &&
                                ...
                                if(ribminus > target->special[SPECIALWOUND_RIBS])
                                    ribminus = target->special[SPECIALWOUND_RIBS];
        ...
        if(melee && aroll < droll - 10 && t.blood > 70 && t.animalgloss == ANIMALGLOSS_NONE
            ...
            if(sneak_attack) {
                ...
                case 1 :
                    strcat(str, " wasn't born yesterday!");
                    break;

                case 2 :
                    strcat(str, " spins and blocks the attack!");
                    break;

                default :
                    strcat(str, " jumps back and cries out in alarm!");
                }
                ...
                switch(LCSrandom(4)) {
                case 0 :
                    strcat(str, " gracefully dives to avoid the attack!");
                    break;

                case 1 :
                    strcat(str, " does the Matrix-dodge!");
                    break;

                case 2 :
                    strcat(str, " leaps for cover!");
                    break;

                default :
                    strcat(str, " avoids the attack with no difficulty at all!");
                }
            } else
                strcat(str, " misses.");
...
void healthmodroll(int &aroll, Creature &a) {
    ...
    if(a.special[SPECIALWOUND_RIGHTLUNG] != 1)
        aroll -= LCSrandom(8);

    if(a.special[SPECIALWOUND_LEFTLUNG] != 1)
        aroll -= LCSrandom(8);

    if(a.special[SPECIALWOUND_HEART] != 1)
        aroll -= LCSrandom(10);

    if(a.special[SPECIALWOUND_LIVER] != 1)
        aroll -= LCSrandom(5);

    if(a.special[SPECIALWOUND_STOMACH] != 1)
        aroll -= LCSrandom(5);

    if(a.special[SPECIALWOUND_RIGHTKIDNEY] != 1)
        aroll -= LCSrandom(5);

    if(a.special[SPECIALWOUND_LEFTKIDNEY] != 1)
        aroll -= LCSrandom(5);

    if(a.special[SPECIALWOUND_SPLEEN] != 1)
        aroll -= LCSrandom(4);

    if(a.special[SPECIALWOUND_LOWERSPINE] != 1)
        aroll -= LCSrandom(100);

    if(a.special[SPECIALWOUND_UPPERSPINE] != 1)
        aroll -= LCSrandom(200);

    if(a.special[SPECIALWOUND_NECK] != 1)
        aroll -= LCSrandom(300);

    if(a.special[SPECIALWOUND_RIBS] < RIBNUM)
        aroll -= LCSrandom(5);

    if(a.special[SPECIALWOUND_RIBS] < RIBNUM / 2)
        aroll -= LCSrandom(5);

    if(a.special[SPECIALWOUND_RIBS] == 0)
        aroll -= LCSrandom(5);
}
...
void specialattack(Creature &a, Creature &t, char &actual) {
    ...
    case CREATURE_SCIENTIST_EMINENT:
        ...
        case 1:
            if(a.align == -1)
                strcat(str, "explains the benefits of research to");
            else
                strcat(str, "explains ethical research to");

            break;

        case 2:
            strcat(str, "discusses the scientific method with");
            break;
        }
    ...
    default:
        if(a.get_weapon().has_musical_attack()) {
            ...
            case 3:
                if(a.align == 1)
                    strcat(str, "plays protest songs at");
                else
                    strcat(str, "plays country songs at");

                break;

            case 4:
                strcat(str, "rocks out at");
                break;
            }
        ...
        if(a.enemy()) {
            if(t.juice > 100) {
                ...
                for(int p = 0; p < 6; p++) {
                    ...
                    if(flipstart && p < 5)
                        activesquad->squad[p] = activesquad->squad[p + 1];
                }
...
void severloot(Creature &cr, vector<Item *> &loot) {
    ...
    if((cr.wound[BODYPART_ARM_LEFT] & WOUND_NASTYOFF) ||
            (cr.wound[BODYPART_ARM_LEFT] & WOUND_CLEANOFF))
        armok--;
...
char incapacitated(Creature &a, char noncombat, char &printed) {
    ...
    if(a.animalgloss == ANIMALGLOSS_TANK) {
        if(a.blood <= 20 || (a.blood <= 50 && (LCSrandom(2) || a.forceinc))) {
            ...
            if(noncombat) {
                ...
                case 1:
                    addstr(" smolders.", gamelog);
                    break;

                case 2:
                    addstr(" burns...", gamelog);
                    break;
                }
            ...
            if(noncombat) {
                ...
                case 1:
                    if(law[LAW_FREESPEECH] == -2)
                        addstr(" [makes a stinky].", gamelog);
                    else
                        addstr(" soils the floor.", gamelog);

                    break;

                case 2:
                    addstr(" yowls pitifully...", gamelog);
                    break;
                }
    ...
    if(a.blood <= 20 || (a.blood <= 50 && (LCSrandom(2) || a.forceinc))) {
        ...
        if(noncombat) {
            ...
            case 26:
                if(a.special[SPECIALWOUND_TEETH] > 1)
                    addstr("'s teeth start chattering.");
                else if(a.special[SPECIALWOUND_TEETH] == 1)
    ...
    if((cr.wound[BODYPART_HEAD] & WOUND_CLEANOFF) ||
        ...
        case 0:
            ...
            if(mode != GAMEMODE_CHASECAR)
                ...
                addstr("is no head, and slumps over.", gamelog);
        ...
        case 1:
            if(mode != GAMEMODE_CHASECAR)
                ...
                strcat(str, " sits headless for a ");
        ...
        case 2:
            ...
            if(mode != GAMEMODE_CHASECAR)
                ...
                addstr("neck and falls to the side.", gamelog);
        ...
        case 1:
            strcat(str, " falls apart and is dead.");
            break;
        }
        ...
        case 7:
            ...
            if(law[LAW_FREESPEECH] == -2)
                addstr("something [good] about Jesus, and dies.", gamelog);
            else
                addstr("something about Jesus, and dies.", gamelog);
...
void autopromote(int loc) {
    ...
    for(int pl = 0; pl < pool.size(); pl++) {
        ...
        if(pool[pl]->alive && pool[pl]->align == 1)
            libnum++;
    }

    if(partysize == 6 && partydead == 0)
        return;
