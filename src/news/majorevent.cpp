...
void constructeventstory(char *story, short view, char positive) {
    ...
    if(positive) {
        ...
        case VIEW_GUNCONTROL: {
            ...
            if(law[LAW_FREESPEECH] == -2)
                strcat(story, "[hurting spree]");
            else
                strcat(story, "shooting rampage");
            ...
            if(law[LAW_FREESPEECH] == -2)
                strcat(story, "[scaring]");
            else
                strcat(story, "spraying bullets at");
            ...
            if(law[LAW_FREESPEECH] == -2)
                strcat(story, "[unfortunately harmed]");
            else
                strcat(story, "shot");
            ...
            if(law[LAW_FREESPEECH] == -2)
                strcat(story, " [feel deeply asleep]");
            else
