    ...
    if(positive) {
        ...
        case VIEW_WOMEN: {
            ...
            if(law[LAW_ABORTION] == -2)
                strcat(story, "A doctor that routinely performed illegal abortion-murders was ruthlessly ");
            else if(law[LAW_ABORTION] == -1)
                strcat(story, "A doctor that routinely performed illegal abortions was ruthlessly ");
            else if(law[LAW_ABORTION] == 0)
                strcat(story, "A doctor that routinely performed semi-legal abortions was ruthlessly ");
            else
            ...
            strcat(story, gen); //TODO: Add more variety, not just in the parking lot.
        ...
        case VIEW_GAY: {
            ...
            case 0:
                if(law[LAW_FREESPEECH] == -2)
                    strcat(story, "throwing [juice boxes]");
                else
            ...
            case 3:
                strcat(story, "the suspects were surrounded by alert citizens, ");
                break;

            case 4:
                strcat(story, "the suspects were caught in traffic, ");
                break;
            }
        ...
        case VIEW_JUSTICES: {
            ...
            case 1:
                ...
                break; // Himself? Maybe themselves would work better? -- LK

            case 2:
                if(law[LAW_FREESPEECH] == -2)
                    strcat(story, "the [civil servant] hollering like a cowboy [at a respectable distance from] the judge.");
                else
        ...
        case VIEW_AMRADIO: {
            ...
            case 0:
                ...
                if(law[LAW_FREESPEECH] == 2)
                    strcat(story, " goddamn mind");
                else if(law[LAW_FREESPEECH] == -2)
                    strcat(story, " [gosh darn] mind");
                else
        ...
        case VIEW_GUNCONTROL: {
            ...
            switch (schtype) {
            case 0:
                strcat(story, "elementary school");

            case 1:
                strcat(story, "middle school");

            case 2:
                strcat(story, "high school");

            case 3:
                strcat(story, "university");
            }
            ...
            int killerage = 6 + (schtype * 4) + LCSrandom(6); //generate an age that would roughly correspond to the schtype
            char astr[3];
            ...
            case 0:
                ...
                if (law[LAW_GUNCONTROL] = 1)
                    strcat(story, "illegal ");
                else if(law[LAW_GUNCONTROL] == 2)
                    strcat(story, "highly illegal ");
            ...
            case 1:
                ...
                if(law[LAW_FREESPEECH] == -2)
                    strcat(story, "[violently attacking] ");
                else
                    strcat(story, "viciously murdering ");
            ...
            case 2:
                ...
                if (schtype != 3)
                    ...
                    strcat(story, "lecture, ");

                if(law[LAW_FREESPEECH] == -2)
                    strcat(story, "[hitting the head]. ");
                else
                    strcat(story, "blowing ");
            ...
            case 0:
                ...
                if(law[LAW_FREESPEECH] == -2)
                    strcat(story, "[left the scene]");
                else
                    strcat(story, "committed suicide");
        ...
        case VIEW_ANIMALRESEARCH: {
            ...
            case 1:
                if(law[LAW_FREESPEECH] == -2)
                    strcat(story, "[helps chimpanzees reproduce]");
                else
        ...
        case VIEW_INTELLIGENCE: {
            ...
            case 2:
                strcat(story, "outcast goths from a suburban high school");
                break;
            }
            ...
            case 0:
                if(law[LAW_FREESPEECH] == -2)
                    strcat(story, "[land] planes [on apartment buildings]");
                else
            ...
            case 5:
                if(law[LAW_FREESPEECH] == -2)
                    strcat(story, "[take] the president [on vacation]");
                else
            ...
            case 6:
                if(law[LAW_FREESPEECH] == -2)
                    strcat(story, "[hurt] the president");
                else
        ...
        case VIEW_GENETICS: {
            ...
            case 2:
                strcat(story, "guy speaking in tongues and worshiping Satan");
                break;
        ...
        case VIEW_JUSTICES: {
            ...
            case 2:
                strcat(story, gen);
                strcat(story, " belief that the crimes were a vast right-wing conspiracy");
                break; // Clinton
        ...
        case VIEW_POLLUTION:
            ...
            switch(LCSrandom(5)) {
            case 0:
                strcat(story, "a modest intake of radioactive waste");
                break;
        ...
        case VIEW_AMRADIO: {
            ...
            case 3:
                if(law[LAW_FREESPEECH] == -2 && law[LAW_WOMEN] == -2)
                    strcat(story, "[fed] from [an indecent] woman");
                else if(law[LAW_FREESPEECH] != -2 && law[LAW_WOMEN] == -2)
            ...
            if(law[LAW_FREESPEECH] == -2)
                strcat(story, "thousands of");
            else if(law[LAW_FREESPEECH] == -1)
                strcat(story, "several hundred");
            else if(law[LAW_FREESPEECH] == 0)
                strcat(story, "hundreds of");
            else if(law[LAW_FREESPEECH] == 1)
                strcat(story, "dozens of");
            else
                strcat(story, "some");
            ...
            if(law[LAW_FREESPEECH] == -2)
                strcat(story, "across the nation. ");
            else if(law[LAW_FREESPEECH] == -1)
                strcat(story, "from all over the state. ");
            else if(law[LAW_FREESPEECH] == 0)
                strcat(story, "within the county. ");
            else if(law[LAW_FREESPEECH] == 1)
                strcat(story, "in neighboring towns. ");
            else
                strcat(story, "within the town. ");
        ...
        case VIEW_GUNCONTROL: {
            ...
            firstname(jstr, jg1);
            lastname(jstr2);
            lastname(jstr3), firstname(jstr4, jg2);
            lastname(jstr5);
            strcat(story, "- In a surprising turn, a ");

            if (law[LAW_FREESPEECH] == -2)
                strcat(story, "[violent rampage]");
            else
                strcat(story, "mass shooting");

            strcat(story, " was prevented by ");

            switch(LCSrandom(3)) {
            case 0:
                strcat(story, "an armed citizen.");
                break;

            case 1:
                strcat(story, "an off-duty police officer.");
                break;

            case 2:
                strcat(story, "a concerned parent.");
                break;
            }
            ...
            if (law[LAW_FREESPEECH] == -2)
                strcat(story, "[attacker]");
            else
                strcat(story, "mass murderer, ");
            ...
            case 0:
                ...
                case 0:
                    ...
                    if (law[LAW_FREESPEECH] == -2)
                        strcat(story, "[decided to fall asleep].");
                    else
                        strcat(story, "committed suicide.");
            ...
            case 1:
                ...
                if (law[LAW_FREESPEECH] == -2)
                    strcat(story, "firefight, [putting the attacker to sleep] ");
                else
                    strcat(story, "firefight, killing the attacker ");
        ...
        case VIEW_PRISONS: {
            ...
            if(law[LAW_FREESPEECH] == -2)
                strcat(story, "   Two weeks ago, convicted [reproduction fiend] ");
            else
            ...
            case 0:
                if(law[LAW_FREESPEECH] == 2)
                    strcat(story, "Ah, fuck this shit.  This punk bitch is fuckin' dead!");
                else if(law[LAW_FREESPEECH] == -2)
                    strcat(story, "Ah, [no way.]  This [police officer will be harmed!]");
                else
            ...
            case 1:
                if(law[LAW_FREESPEECH] == 2)
                    strcat(story, "Fuck a muthafuckin' bull.  I'm killin' this pig shit.");
                else if(law[LAW_FREESPEECH] == -2)
                    strcat(story, "[Too late.]  [I am going to harm this police officer.]");
                else
