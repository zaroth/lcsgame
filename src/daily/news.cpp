        ...
        default: {
            ...
            if(ns.type == NEWSSTORY_SQUAD_KILLED_SITE) {
                if(liberalguardian)
                    ...
                    strcat(story, "Everyone in the LCS group was arrested or killed.  ");
                else
                    strcat(story, "Fortunately, the LCS thugs was stopped by brave citizens.  ");
            }
...
void generatefiller(char *story, int32 amount) {
    ...
    while(amount > 0) {
        ...
        for(int32 i = 0; i < LCSrandom(10) + 3; i++)
            strcat(story, "~");
