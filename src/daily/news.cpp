...
void setpriority(newsstoryst &ns) {
    ...
    case NEWSSTORY_BURIALARREST: {
        ...
        if(crime[CRIME_FREE_RABBITS] > 10)
            crime[CRIME_FREE_RABBITS] = 10;

        if(crime[CRIME_FREE_BEASTS] > 10)
            crime[CRIME_FREE_BEASTS] = 10;

        if(crime[CRIME_TAGGING] > 10)
            crime[CRIME_TAGGING] = 10;
...
void displaystory(newsstoryst &ns, bool liberalguardian, int header) {
    ...
    case NEWSSTORY_BURIALARREST: {
        ...
        case NEWSSTORY_BURIALARREST: {
            ...
            if(crime[CRIME_KILLEDSOMEBODY] > 1)
                ...
                strcat(story, "The name of the officer has not been released pending notification of the officer's family.");
        ...
        default: {
            ...
            if(ns.type == NEWSSTORY_CCS_KILLED_SITE || ns.type == NEWSSTORY_CCS_SITE)
                ccs = 1;
    ...
    case NEWSSTORY_MASSACRE: {
        ...
        if(!liberalguardian) {
            ...
            if(ns.crime[1] > 1)
                strcat(story, "victims were members ");
            else
                strcat(story, "victim was a member ");
        ...
        case SIEGE_CIA:
            if(!liberalguardian) {
                ...
                if(law[LAW_FREESPEECH] == -2)
                    strcat(story, "[Craziest] thing I've ever seen");
        ...
        case SIEGE_FIREMEN:
            if(!liberalguardian) {
                if(ns.crime[1] > 1)
                    ...
                    strcat(story, "The recovered body was ");
                ...
                if(ns.crime[1] > 1)
                    ...
                    strcat(story, "The murdered was a reporter ");
...
void majornewspaper(char &clearformess, char canseethings) {
    ...
    if(!LCSrandom(60)) {
        ...
        do {
            ...
            if(ns->view == VIEW_IMMIGRATION)
                continue;

            if(ns->view == VIEW_DRUGS)
                continue;

            if(ns->view == VIEW_MILITARY)
                continue;
            ...
            //NO DEATH PENALTY
            if(ns->view == VIEW_DEATHPENALTY && law[LAW_DEATHPENALTY] == 2)
                continue;
