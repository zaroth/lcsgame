    ...
    for(int l = 0; l < (int)location.size(); l++) {
        ...
        if(location[l]->siege.timeuntillocated == -2) {
            ...
            for(int p = 0; p < (int)pool.size(); p++) {
                ...
                if(pool[p]->location != l || pool[p]->flag & CREATUREFLAG_SLEEPER)
                    continue;
            ...
            if(!crimes) {
                ...
                if(LCSrandom(3000) < location[l]->heat
                    ...
                    if(LCSrandom(location[l]->heat) > 50)
                        location[l]->siege.escalationstate++;

                    if(LCSrandom(location[l]->heat) > 150)
                        location[l]->siege.escalationstate++;

                    if(LCSrandom(location[l]->heat) > 300)
                        location[l]->siege.escalationstate++;
            ...
            //CORPS
            if(location[l]->heat && location[l]->siege.timeuntilcorps == -1 && !location[l]->siege.siege && offended_corps && !LCSrandom(600) &&
                    numpres > 0) {
                ...
                if(ceosleepercount || !LCSrandom(5)) {
                    ...
                    if(ceosleepercount)
                        addstr("your sleeper CEO's warning", gamelog);
                    else
                        addstr("an anonymous tip", gamelog);
            ...
            //CIA
            if(location[l]->heat && location[l]->siege.timeuntilcia == -1 && !location[l]->siege.siege && offended_cia && !LCSrandom(300) &&
                    numpres > 0) {
            ...
            if(law[LAW_FREESPEECH] == -2 && location[l]->siege.timeuntilfiremen == -1 && !location[l]->siege.siege &&
                ...
                location[l]->siege.timeuntilfiremen--;
    ...
    for(l = 0; l < (int)location.size(); l++) {
        if(location[l]->siege.siege) {
            ...
            if(!location[l]->siege.underattack) {
                ...
                if(location[l]->compound_stores >= eaters)
                    location[l]->compound_stores -= eaters;
                else
                ...
                if(attack) {
                    ...
                    if(!LCSrandom(20) && no_bad && liberalcount[l] > 0) {
                        ...
                        switch(LCSrandom(5)) {
                        case 0:
                            addstr("news program", gamelog);
                            break;

                        case 1:
                            addstr("news magazine", gamelog);
                            break;

                        case 2:
                            addstr("website", gamelog);
                            break;

                        case 3:
                            addstr("scandal rag", gamelog);
                            break;

                        case 4:
                            addstr("newspaper", gamelog);
                            break;
                        }
                        ...
                        switch(LCSrandom(12)) {
                        case 0:
                            addstr("Daily", gamelog);
                            break;

                        case 1:
                            addstr("Nightly", gamelog);
                            break;

                        case 2:
                            addstr("Current", gamelog);
                            break;

                        case 3:
                            addstr("Pressing", gamelog);
                            break;

                        case 4:
                            addstr("Socialist", gamelog);
                            break;

                        case 5:
                            addstr("American", gamelog);
                            break;

                        case 6:
                            addstr("National", gamelog);
                            break;

                        case 7:
                            addstr("Union", gamelog);
                            break;

                        case 8:
                            addstr("Foreign", gamelog);
                            break;

                        case 9:
                            addstr("Associated", gamelog);
                            break;

                        case 10:
                            addstr("International", gamelog);
                            break;

                        case 11:
                            addstr("County", gamelog);
                            break;
                        }
                        ...
                        switch(LCSrandom(11)) {
                        case 0:
                            addstr("Reporter", gamelog);
                            break;

                        case 1:
                            addstr("Issue", gamelog);
                            break;
                        ...
                        case 3:
                            addstr("Constitution", gamelog);
                            break;

                        case 4:
                            addstr("Times", gamelog);
                            break;
                        ...
                        case 7:
                            addstr("Affair", gamelog);
                            break;

                        case 8:
                            addstr("Statesman", gamelog);
                            break;
                        ...
                        if(segmentpower < 15) {
                            ...
                            case 2:
                                addstr("Insane", gamelog);
                                break;

                            case 3:
                                addstr("Crazy", gamelog);
                                break;

                            case 4:
                                addstr("Loopy", gamelog);
                                break;

                            case 5:
                                addstr("Idiot", gamelog);
                                break;

                            case 6:
                                addstr("Empty-Headed", gamelog);
                                break;

                            case 7:
                                addstr("Nutty", gamelog);
                                break;

                            case 8:
                                addstr("Half-Baked", gamelog);
                                break;

                            case 9:
                                addstr("Pot-Smoking", gamelog);
                                break;

                            case 10:
                                addstr("Stoner", gamelog);
                                break;
                            }
                            ...
                            case 2:
                                addstr("Anarchist", gamelog);
                                break;

                            case 3:
                                addstr("Communist", gamelog);
                                break;

                            case 4:
                                addstr("Marxist", gamelog);
                                break;

                            case 5:
                                addstr("Green", gamelog);
                                break;

                            case 6:
                                addstr("Elite", gamelog);
                                break;

                            case 7:
                                addstr("Guerrilla", gamelog);
                                break;

                            case 8:
                                addstr("Commando", gamelog);
                                break;

                            case 9:
                                addstr("Soldier", gamelog);
                                break;
                            }
...
void giveup(void) {
    ...
    if(activesquad != NULL)
        loc = activesquad->squad[0]->location;
    ...
    if(location[loc]->siege.siegetype == SIEGE_POLICE ||
        ...
        for(p = pool.size() - 1; p >= 0; p--) {
            ...
            if(pool[p]->flag & CREATUREFLAG_MISSING && pool[p]->align == -1) {
                ...
                if(pool[p]->type == CREATURE_RADIOPERSONALITY)
                    offended_amradio = 1;

                if(pool[p]->type == CREATURE_NEWSANCHOR)
        ...
        if(kcount > 0)
            criminalizepool(LAWFLAG_KIDNAPPING, -1, loc);

        if(icount > 0)
            criminalizepool(LAWFLAG_HIREILLEGAL, -1, loc);
        ...
        if(location[loc]->siege.siegetype == SIEGE_FIREMEN) {
            if(location[loc]->compound_walls & COMPOUND_PRINTINGPRESS) {
                ...
                if(icount > 0)
                    criminalizepool(LAWFLAG_SPEECH, -1, loc);
            }
        }
        ...
        for(p = pool.size() - 1; p >= 0; p--) {
            ...
            if(pool[p]->squadid != -1) {
                ...
                if(sq != -1)
                    delete_and_clear(squad[sq]->loot);
            }
...
int fooddaysleft(int loc) {
    ...
    if((location[loc]->compound_stores % eaters) > eaters / 2)
        days++;
...
void sally_forth(void) {
    ...
    //CRIMINALIZE
    if(location[loc]->siege.siegetype == SIEGE_POLICE)
        criminalizepool(LAWFLAG_RESIST, -1, loc);
...
void escape_engage(void) {
    ...
    if(location[loc]->siege.underattack)
        ns->type = NEWSSTORY_SQUAD_FLEDATTACK;
    else
        ns->type = NEWSSTORY_SQUAD_ESCAPED;
...
void statebrokenlaws(int loc) {
    ...
    if(location[loc]->siege.underattack)
        addstr("You hear shouts:", gamelog);
    else
        addstr("You hear a blaring voice on a loudspeaker:", gamelog);
    ...
    //BURN FLAG
        ...
        if(law[LAW_FLAGBURNING] == -2)
            addstr("You are wanted for Flag Murder", gamelog);
        else if(law[LAW_FLAGBURNING] == -1)
            addstr("You are wanted for felony flag burning", gamelog);
        else
            addstr("You are wanted for flag burning", gamelog);
    }
    //SPEECH
    ...
    //HIRE ILLEGAL
        ...
        if(law[LAW_IMMIGRATION] < 1)
            addstr("You are wanted for hiring an illegal alien", gamelog);
        else
            addstr("You are wanted for hiring an undocumented worker", gamelog);
    }
    //GUN USE
    ...
    if(!kidnapped) {
        if(typenum > 1)
            addstr(" and other crimes", gamelog);
