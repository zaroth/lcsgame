    ...
    while(1) {
        ...
        case PAGE_LEADERS: {
            ...
            for(int l = 0; l < LAWNUM; l++) {
                ...
                if(law[l] == ALIGN_ARCHCONSERVATIVE)
                    set_color(COLOR_RED, COLOR_BLACK, 1);
                else if(law[l] == ALIGN_CONSERVATIVE)
                    set_color(COLOR_MAGENTA, COLOR_BLACK, 1);
                else if(law[l] == ALIGN_MODERATE)
                    set_color(COLOR_YELLOW, COLOR_BLACK, 1);
                else if(law[l] == ALIGN_LIBERAL)
                    set_color(COLOR_CYAN, COLOR_BLACK, 1);
                else
                    set_color(COLOR_GREEN, COLOR_BLACK, 1);
        ...
        case PAGE_ISSUES_B: {
            ...
            for(int l = startinglaw; l < startinglaw + 18 && l < LAWNUM; l++) {
                ...
                case LAW_CIVILRIGHTS:
                    if(won == -2)
                        addstr("Entire ethnic groups are branded \"enemies of the state\".");
                    else if(won == -1)
                        addstr("Segregation has been reintroduced.");
                    else if(law[l] == ALIGN_ARCHCONSERVATIVE)
                        addstr("Racial discrimination is prohibited in name only.");
                    else if(law[l] == -1)
                        addstr("Civil rights laws are inconsistently enforced.");
                    else if(law[l] == 0)
                ...
                case LAW_DRUGS:
                    if(won == -2)
                        addstr("Vodka is the only legal recreational drug in the People's Republic of America.");
                    else if(won == -1)
                        addstr("Talking about recreational drugs is punishable by death.");
                    else if(law[l] == ALIGN_ARCHCONSERVATIVE)
                        addstr("Violent criminals are released to make room for drug offenders.");
                    else if(law[l] == -1)
                        addstr("Prisons are filled with the targets of a war on drugs.");
                    else if(law[l] == 0)
                ...
                case LAW_IMMIGRATION:
                    if(won == -2)
                        addstr("All Americans must carry around an internal passport, or be shot on sight.");
                    else if(won == -1)
                        addstr("Border guards shoot suspected foreigners on sight.");
                    else if(law[l] == ALIGN_ARCHCONSERVATIVE)
                        addstr("Immigration is illegal, and noncitizens are shipped to Mexico at gunpoint.");
                    else if(law[l] == -1)
                        addstr("The military has been deployed to the borders to slow immigration.");
                    else if(law[l] == 0)
                ...
                case LAW_ELECTIONS:
                    if(won == -2)
                        addstr("Only Stalinist Party members may run in elections, and they all run unopposed.");
                    else if(won == -1)
                        addstr("Only independently wealthy candidates have a chance of defeating incumbents.");
                    else if(law[l] == ALIGN_ARCHCONSERVATIVE)
                        addstr("Virtually no ethics restrictions exist on political officeholders.");
                    else if(law[l] == -1)
                        addstr("Elections are mostly unregulated, but basic ethics restrictions are in place.");
                    else if(law[l] == 0)
                ...
                case LAW_MILITARY:
                    if(won == -2)
                        addstr("The military promotes Stalinism throughout the world by using force.");
                    else if(won == -1)
                        addstr("The massive military is a tool of political oppression.");
                    else if(law[l] == ALIGN_ARCHCONSERVATIVE)
                        addstr("Ballooning military boondoggles are utterly out of control.");
                    else if(law[l] == -1)
                        addstr("Massive investment is put into the military.");
                    else if(law[l] == 0)
                ...
                case LAW_TORTURE:
                    if(won == -2)
                        addstr("The Cheka constantly invents new methods of torture.");
                    else if(won == -1)
                        addstr("Torture is a prescribed practice in police interrogations.");
                    else if(law[l] == ALIGN_ARCHCONSERVATIVE)
                        addstr("Military and intelligence interrogators regularly engage in torture.");
                    else if(law[l] == -1)
                        addstr("The line between standard interrogation and torture is severely blurred.");
                    else if(law[l] == 0)
                ...
                case LAW_PRISONS:
                    if(won == -2)
                        addstr("The former nation of Canada has been annexed and filled with Stalinist gulags.");
                    else if(won == -1)
                ...
                case LAW_TAX:
                    if(won == -2)
                        addstr("Having any money whatsoever is punishable by 20 years in a gulag.");
                    else if(won == -1)
                ...
                case LAW_ABORTION:
                    if(won == -2)
                        addstr("Mandatory abortions are carried out for population control.");
                    else if(won == -1)
                        addstr("Use of contraception and abortion are capital offenses.");
                    else if(law[l] == ALIGN_ARCHCONSERVATIVE)
                        addstr("Abortion is a felony equal to murder.");
                    else if(law[l] == -1)
                        addstr("Abortion is prohibited except in extreme circumstances.");
                    else if(law[l] == 0)
                ...
                case LAW_ANIMALRESEARCH:
                    if(won == -2)
                        addstr("All forms of human experimentation on \"class enemies\" are encouraged.");
                    else if(won == -1)
                ...
                case LAW_POLICEBEHAVIOR:
                    if(won == -2)
                        addstr("Everyone lives in constant fear of the Stalinist Party's Secret Police.");
                    else if(won == -1)
                ...
                case LAW_PRIVACY:
                    if(won == -2)
                        addstr("Citizens have to spy on each other and report to the Stalinist Party.");
                    else if(won == -1)
                ...
                case LAW_DEATHPENALTY:
                    if(won == -2)
                        addstr("Class enemies receive mandatory death sentences.");
                    else if(won == -1)
                ...
                case LAW_NUCLEARPOWER:
                    if(won == -2)
                        addstr("Nuclear power plants routinely have meltdowns but keep getting built.");
                    else if(won == -1)
                ...
                case LAW_POLLUTION:
                    if(won == -2)
                        addstr("State-run industries pollute so much, the workers all have cancer.");
                    else if(won == -1)
                ...
                case LAW_LABOR:
                    if(won == -2)
                        addstr("The state has nationalized all industries and assigns everyone jobs.");
                    else if(won == -1)
                ...
                case LAW_GAY:
                    if(won == -2)
                        addstr("Homosexuals are executed regularly for their \"bourgeoisie decadence\".");
                    else if(won == -1)
                ...
                case LAW_CORPORATE:
                    if(won == -2)
                        addstr("All forms of private enterprise are punishable by death.");
                    else if(won == -1)
                ...
                case LAW_FREESPEECH:
                    if(won == -2)
                        addstr("Counterrevolutionary speech is a capital crime.");
                    else if(won == -1)
                ...
                case LAW_FLAGBURNING:
                    if(won == -2)
                        addstr("Flags of the old American regime are burnt primarily as as fuel.");
                    else if(won == -1)
                ...
                case LAW_GUNCONTROL:
                    if(won == -2)
                        addstr("Anyone owning a gun is executed by firing squad.");
                    else if(won == -1)
...
char confirmdisband(void) { // The (current) issue that the masses are most
    ...
    case 1:
        ...
        break;                  // Child Safety                 // Thoughtcrime          //

    case 2:
        strcpy(word, "Gay Marriage");
        break;                 // Sancitity of Marriage        //                       //
    ...
    case 6:
        ...
        break;                  // Second Amendment             // Firing Squad          //

    case 7:
        strcpy(word, "Campaign Finance Reform");
        break;      // Freedom to Campaign          //                       //
    ...
    case 15:
        strcpy(word, "Right To Privacy");
        break;            // Wiretapping                  // Big Brother           //
    ...
    do {
        ...
        set_color(COLOR_WHITE, COLOR_BLACK, 0);
        move(2, 0);
        addstr("Disbanding scatters the Liberal Crime Squad, sending all of its members");
        move(3, 0);
        addstr("into hiding, free to pursue their own lives.  You will be able to observe");
        move(4, 0);
        addstr("the political situation in brief, and wait until a resolution is reached.");

        move(6, 0);
        addstr("If at any time you determine that the Liberal Crime Squad will be needed");
        move(7, 0);
        addstr("again, you may return to the homeless shelter to restart the campaign.");

        move(9, 0);
        addstr("Do not make this decision lightly.  If you do need to return to action,");
        move(10, 0);
        addstr("only the most devoted of your former members will return.");
