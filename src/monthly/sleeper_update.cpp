...
void sleeper_steal(Creature &cr, char &clearformess, char canseethings, int *libpower) {
    ...
    while(number_of_items--) {
        ...
        case SITE_LABORATORY_GENETIC:
            if(!LCSrandom(5))
                item = "LOOT_RESEARCHFILES";
            else if(!LCSrandom(2))
                item = "LOOT_LABEQUIPMENT";
            else if(!LCSrandom(2))
                item = "LOOT_COMPUTER";
            else if(!LCSrandom(5))
                item = "LOOT_PDA";
        ...
        case SITE_MEDIA_AMRADIO:
            if(!LCSrandom(5))
                item = "LOOT_AMRADIOFILES";
            else if(!LCSrandom(4))
                item = "LOOT_MICROPHONE";
            else if(!LCSrandom(3))
                item = "LOOT_PDA";
            else if(!LCSrandom(2))
                item = "LOOT_CELLPHONE";
