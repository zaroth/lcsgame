...
case LAW_DRUGS:
S: "Vodka is the only legal recreational drug in the USA."
...
case LAW_ELECTIONS:
S: "Only Stalinist Party members may run in elections."
...
case LAW_MILITARY:
S: "The military promote Stalinism throughout the world by using force."
...
case LAW_TORTURE:
S: "The Cheka constanly invents new methods of torture."
...
M: "Government human rights abuses still occasionally crop up."
L: "The government has a strong reputation on human rights issues."
L + : "The country is respected as an international leader on human rights."


case LAW_TAX:
S: "Having any money whatsoever is considered a criminal offense."
...
case LAW_ABORTION:
S: "Use of contraception and abortion are capital offenses."
...
S: "The police is administered by the Stalinist Party and has a draft."
C++: "Policing is administered by corporations and has a draft."
C + : "Law enforcement is given free reign."
C: "Law enforcement is lightly regulated."
M: "Law enforcement is moderately regulated."
L: "Law enforcement is strictly controlled."
L + : "All law enforcement positions are subject to election and recall."


case LAW_PRIVACY:
S: "Files on each citizen are easily accessible to the Stalinist Party."
...
S: "Nuclear power plants are ubiquitous."
...
case LAW_POLLUTION:
S: "Industry is subject to zero-tolerance pollution regulations."
...
case LAW_LABOR:
S: "The state has nationalized all industries."
...
case LAW_GAY:
S: "Homosexuals are executed regularly."
...
case LAW_CORPORATE:
S: "Belonging to a corporation is a criminal offense."
...
case LAW_FREESPEECH:
S: "Unacceptable speech is a capital crime."
